...
| ------------------ | ------------------ | ---------------------------- | ---------------------------------------------------- | ----------- |
| `centered`         | `centered`         | Is modal centered            | `boolean \| undefined`                               | `undefined` |
| `closeText`        | `close-text`       | Close button text            | `string \| undefined`                                | `undefined` |
| `fullScreen`       | `full-screen`      | Is fullscreen in all sizes   | `boolean \| undefined`                               | `undefined` |
| `fullScreenSize`   | `full-screen-size` | Size to apply the fullscreen | `"lg" \| "md" \| "sm" \| "xl" \| "xxl" \| undefined` | `undefined` |
