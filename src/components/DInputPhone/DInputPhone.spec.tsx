  ...
  expect(container).toMatchInlineSnapshot(`
    <div>
      ...
      >
        ...
        >
          <div
            class="react-international-phone-country-selector input-group-text dropdown"
          >
            <button
              aria-expanded="false"
            ...
            <ul
              ...
              class="react-international-phone-country-selector-dropdown dropdown-menu"
              role="listbox"
              style="display: none;"
              tabindex="-1"
            >
              <li
                aria-label="Chile +56"
                aria-selected="true"
                class="react-international-phone-country-selector-dropdown__list-item react-international-phone-country-selector-dropdown__list-item--selected react-international-phone-country-selector-dropdown__list-item--focused dropdown-item"
                data-country="cl"
              ...
              >
                ...
                <span
                  class="react-international-phone-country-selector-dropdown__list-item-dial-code fw-bold"
                >
                  +
                  56
                </span>
              ...
              <li
                ...
                aria-selected="false"
                class="react-international-phone-country-selector-dropdown__list-item dropdown-item"
                data-country="co"
