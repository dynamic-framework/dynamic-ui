...
describe('<DQuickActionSelect />', () => {
  describe('Rendering and Props', () => {
    ...
    it('should render with correct labels and value', () => {
      render(
        <DContextProvider>
          <DQuickActionSelect
            name="test"
    ...
    it('should be checked when the selected prop is true', () => {
      render(
        <DContextProvider>
          <DQuickActionSelect
            name="test"
  ...
  describe('User Interaction and Events', () => {
    ...
    it('should function as a radio button in a group', async () => {
      const user = userEvent.setup();
      function TestGroup() {
    ...
    it('should handle the case where the ref is not initially available', () => {
      const { rerender } = render(
        <DContextProvider>
          <DQuickActionSelect name="test" line1="test" line2="test" value="test" selected={false} />
        </DContextProvider>,
      );
      ...
      rerender(
        <DContextProvider>
          <DQuickActionSelect name="test" line1="test" line2="test" value="test" selected />
        </DContextProvider>,
      );
