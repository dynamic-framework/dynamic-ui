 ...
 *
 * Numbers count as text: React renders them as their string form and so does
 * `String()`, which is what the string-only attributes end up receiving.
 */
export default function isTextLabel(label: ReactNode): label is string | number {
