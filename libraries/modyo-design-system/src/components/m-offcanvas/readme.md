...
| `openFrom`          | `open-from`         | Position to show offcanvas from | `"bottom" \| "end" \| "start" \| "top"` | `'start'`   |
| `scrollable`        | `scrollable`        | Is offcanvas scrollable         | `boolean \| undefined`                  | `undefined` |
