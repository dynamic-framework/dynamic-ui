...
| `rightIconCustomAction`      | `right-icon-custom-action`       | Right custom icon clickable                      | `string \| undefined`                                                                                               | `undefined` |
| `rightIconCustomActionClass` | `right-icon-custom-action-class` | Right custom icon class                          | `string \| undefined`                                                                                               | `undefined` |
