...
| ------------- | ------------------------ | --------------------- |
| `eventChange` | Event for input change   | `CustomEvent<number>` |
| `eventClick`  | Event for button pressed | `CustomEvent<number>` |
...
graph TD;
  ...
  d-input --> d-icon
  style d-input-counter fill:#f9f,stroke:#333,stroke-width:4px
```
