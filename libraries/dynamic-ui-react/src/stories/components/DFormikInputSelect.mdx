...
import * as DFormikInputSelectStories from './DFormikInputSelect.stories';

# Formik Input Select

Component composition to use a `d-input-select` with Formik.
...
## Args
<Meta of={DFormikInputSelectStories} />

<ArgTypes of={DFormikInputSelectStories} />
