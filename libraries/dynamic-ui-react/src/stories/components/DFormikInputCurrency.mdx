...
import * as DFormikInputCurrencyStories from './DFormikInputCurrency.stories';

# Formik Input Currency

Component composition with `d-input-currency` to make a currency input component that use
...
<Markdown>
  ...
  | \`--${PREFIX_BS}input-label-focus-color\`           | css color unit  | Label focus color             |
...
## Args
<Meta of={DFormikInputCurrencyStories} />

<ArgTypes of={DFormikInputCurrencyStories} />
