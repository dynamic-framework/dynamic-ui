...
import * as DFormikInputStories from './DFormikInput.stories';

# Formik Input

Component composition to use a `d-input` with Formik.
...
## Args
<Meta of={DFormikInputStories} />

<ArgTypes of={DFormikInputStories} />
