...
* **storybook:** add componentsManifest feature and update tags in preview config ([afd87eb](https://github.com/dynamic-framework/dynamic-ui/commit/afd87eb1890963607f15c4899fb34c7c575731e5))
...
* This release introduces breaking changes incompatible with v1 of the design system. Previously available public APIs, components, and props have been removed or modified that require manual migration.

### Features

* accumulated breaking changes for v2 and update README ([#926](https://github.com/dynamic-framework/dynamic-ui/issues/926)) ([9b7ce0b](https://github.com/dynamic-framework/dynamic-ui/commit/9b7ce0bd9f4863f9e1cebcac3d63448d37f8d37d))
* add base stories and DDropdown and DCreditCard ([e0ebcd7](https://github.com/dynamic-framework/dynamic-ui/commit/e0ebcd733238719881f1fff1e692352d7bac92f0))
* add carousel examples ([ddbf439](https://github.com/dynamic-framework/dynamic-ui/commit/ddbf439d411b0569b462f9c0ad32002b7ccb39a6))
* add children prop to buttons ([6be5543](https://github.com/dynamic-framework/dynamic-ui/commit/6be5543acd19420d27727b04facad91af39137f6))
* add component state colors in Alert component ([3c95427](https://github.com/dynamic-framework/dynamic-ui/commit/3c95427d0671876eebba6b0771d42bfd80ac8274))
* add custom height prop ([72cd876](https://github.com/dynamic-framework/dynamic-ui/commit/72cd876db86823d081b8561ebe7c294b0acd04e6))
* add dashboard stories ([4f0255a](https://github.com/dynamic-framework/dynamic-ui/commit/4f0255a3cc9b1c440b885df7c5b0a3db25880408))
* add dev publish workflow ([#889](https://github.com/dynamic-framework/dynamic-ui/issues/889)) ([b31840e](https://github.com/dynamic-framework/dynamic-ui/commit/b31840ed92f9023d3cb9f32159360c047b6e4dff))
* add environment variable for storybook dev version display ([a91d7c6](https://github.com/dynamic-framework/dynamic-ui/commit/a91d7c62bb46d0bd85017fd68481b9fca3580fe9))
* add example horizontal form ([652b4c6](https://github.com/dynamic-framework/dynamic-ui/commit/652b4c69fac992a3c35c208206302b9e28322c84))
* add gap responsive in dlayout component ([b255b3e](https://github.com/dynamic-framework/dynamic-ui/commit/b255b3e3eb1993a1162c228e6b8c56045f283e2d))
* add new d-voucher component ([#900](https://github.com/dynamic-framework/dynamic-ui/issues/900)) ([dadf79f](https://github.com/dynamic-framework/dynamic-ui/commit/dadf79f8dc292ec4a67a5bead2462f97dcd6f872))
* add new finatiallist stories, and extend color palette ([6c5ffc8](https://github.com/dynamic-framework/dynamic-ui/commit/6c5ffc827004949f615f8aa99962511e55fc2f1b))
* add new layout component ([4e7ee67](https://github.com/dynamic-framework/dynamic-ui/commit/4e7ee6765a4930e25c80b7ef72da1f248fc1d83a))
* add new variant toggle button group ([12eb4d3](https://github.com/dynamic-framework/dynamic-ui/commit/12eb4d30c638ff3024d09249eb218ba3f032f4f8))
* add portal transitions with framer-motion ([#909](https://github.com/dynamic-framework/dynamic-ui/issues/909)) ([38524be](https://github.com/dynamic-framework/dynamic-ui/commit/38524bec7ea1e6596a1f3bba49196a81b47422d4))
* add quickactions story ([a9d15b0](https://github.com/dynamic-framework/dynamic-ui/commit/a9d15b07aa31fdf072d47018b0778399ced1c057))
* add responsive size support to DIcon component and implement useResponsiveProp hook ([#915](https://github.com/dynamic-framework/dynamic-ui/issues/915)) ([b7cabaf](https://github.com/dynamic-framework/dynamic-ui/commit/b7cabaffe2ed947ee563cec98e6823f27098b2ca))
* adjust forms stories and refactor dinputcheck dinputswitch classname prop ([#901](https://github.com/dynamic-framework/dynamic-ui/issues/901)) ([2110dae](https://github.com/dynamic-framework/dynamic-ui/commit/2110daee2fcb67a287a45ee5274e1ca35f55f9ad))
* adjustement alert ([2f2a9b7](https://github.com/dynamic-framework/dynamic-ui/commit/2f2a9b7754a4189d488a6f4fea8d7215ecd055a0))
* adjustement card ([dc5e727](https://github.com/dynamic-framework/dynamic-ui/commit/dc5e7276115d6db11220683d19f80e6f674a1b1f))
* adjustement doc of badges ([4e57a30](https://github.com/dynamic-framework/dynamic-ui/commit/4e57a3083a9eec64a96ded35f69dfdf6617c2827))
* adjustement focus and master detail story ([3cc1073](https://github.com/dynamic-framework/dynamic-ui/commit/3cc107315b5dc76d2f69feee2187d27b8863a259))
* adjustement spacers and colors ([8980860](https://github.com/dynamic-framework/dynamic-ui/commit/8980860480356267abb5f85f87c49aaddbb37fb7))
* adjustement stepper desktop ([4571624](https://github.com/dynamic-framework/dynamic-ui/commit/457162492fbbb10d8f72bede6d0bcfc79a5ec141))
* adjustement tables examples ([1684df1](https://github.com/dynamic-framework/dynamic-ui/commit/1684df1c0fc9c1b707352d50b9fe44e90c660e88))
* adjustement toast stories ([42f2dd1](https://github.com/dynamic-framework/dynamic-ui/commit/42f2dd12ec11afd46720690a48f8b665323706de))
* adjustement vertical mode ([be60e23](https://github.com/dynamic-framework/dynamic-ui/commit/be60e2389ddd4d320d7e12030b205c17fa5852f7))
* adjustment alert colors ([ab3bd53](https://github.com/dynamic-framework/dynamic-ui/commit/ab3bd533fd8028798b5af65be2d1145834886eb5))
* adjustment dropdown, offcanvas, button link ([9503784](https://github.com/dynamic-framework/dynamic-ui/commit/9503784c6411391acca9b088651085947faa5c48))
* adjustment some stories ([6f43c83](https://github.com/dynamic-framework/dynamic-ui/commit/6f43c83fb73206caa6309e1bebcdc687020e2f71))
* adjustment stories ([e2a772f](https://github.com/dynamic-framework/dynamic-ui/commit/e2a772f26b99afe0d7eedf1569089c3f98669906))
* adjustment tab type and examples, redesign pills ([0b8e98a](https://github.com/dynamic-framework/dynamic-ui/commit/0b8e98a122be5ad687aab187ff648e4cabafb27a))
* ajuste botones en mixing ([6274614](https://github.com/dynamic-framework/dynamic-ui/commit/6274614374d24f9b88a1f7a84ccf3feec9ab45ec))
* ajuste dtooltip ([c4cf805](https://github.com/dynamic-framework/dynamic-ui/commit/c4cf805e626be77bbaa15e8f09f3eb2d36456c8d))
* ajuste focus ([cb0a102](https://github.com/dynamic-framework/dynamic-ui/commit/cb0a102f73a4de9e3e89984f9b532993c4e0eed1))
* badge fix ([11b09f2](https://github.com/dynamic-framework/dynamic-ui/commit/11b09f2875a7a712e7b9da455e58b64214dc43b9))
* base new design ([af9cc39](https://github.com/dynamic-framework/dynamic-ui/commit/af9cc39f099c9cae6f426863270559f3680f2ba6))
* button fix ([a597a96](https://github.com/dynamic-framework/dynamic-ui/commit/a597a96e26b415672c83bbe3d61babaf1c8129ba))
* buttons secondary ([2d2761f](https://github.com/dynamic-framework/dynamic-ui/commit/2d2761f31f6d4b065bcb5f30778dbc6aac3bf72e))
* card, badge, buttons ([c8bbf47](https://github.com/dynamic-framework/dynamic-ui/commit/c8bbf47bcf0d714d0c0d8d9a7c98ddb75e59912e))
* carousel, utilities and badges ([f2d9b70](https://github.com/dynamic-framework/dynamic-ui/commit/f2d9b70f4d00bb3860c4f7ad4595b7260698e7a4))
* creditcard story ([4573a91](https://github.com/dynamic-framework/dynamic-ui/commit/4573a910d4d0576296364066f8a792b8ed085324))
* dashboard base story ([4c6c7d6](https://github.com/dynamic-framework/dynamic-ui/commit/4c6c7d6fbf515ce54209763666fe05f3f8b1025e))
* dashboard patterns ([876997a](https://github.com/dynamic-framework/dynamic-ui/commit/876997ad838ee414eb230da67c2801d2ae669527))
* datepicker adjustment, input-group-text color to gray-400 ([73ada83](https://github.com/dynamic-framework/dynamic-ui/commit/73ada836be7507f27e74c0f00f0283808f0c05dc))
* dcreditcard ajustements vars ([37d5a8d](https://github.com/dynamic-framework/dynamic-ui/commit/37d5a8dcb35c476b442b3eb65e66959f8915b6d1))
* ddatepicker and dropdowns adjustements paddings ([43c85e7](https://github.com/dynamic-framework/dynamic-ui/commit/43c85e7d4426141a21cd3923ae5216837130da73))
* ddropdown ajustments and story ([fda00b5](https://github.com/dynamic-framework/dynamic-ui/commit/fda00b53489e9222dfbe25935dc50cd5f0cb35ae))
* ddropdown ajustments and story ([12d5379](https://github.com/dynamic-framework/dynamic-ui/commit/12d537950e68d5676b50a8bbfd6826619d287034))
* dmodal fix gap, and remove size props on creditcard component ([e62a6d7](https://github.com/dynamic-framework/dynamic-ui/commit/e62a6d7e1e89e2033ced7eb8c55b9802bf6d962a))
* dotp component ([5d65730](https://github.com/dynamic-framework/dynamic-ui/commit/5d6573007164774539e3617183f477809a75e634))
* dotp component ([30c0e68](https://github.com/dynamic-framework/dynamic-ui/commit/30c0e68c11c2639c0536f9efe02b7e1ab7c66e2b))
* dropdown vars ([c7252e6](https://github.com/dynamic-framework/dynamic-ui/commit/c7252e667d644caf5de5ffed4b56812caa1992f1))
* establece la versión de pre-lanzamiento para V2 ([e62e478](https://github.com/dynamic-framework/dynamic-ui/commit/e62e4787f183ad1e181fd853abaa89c21bb0d736))
* forms with fieldset ([10143b5](https://github.com/dynamic-framework/dynamic-ui/commit/10143b5b2b6233da804b400c29e00f2ba9f5fce6))
* iconstart iconend in listgroup ([9742edd](https://github.com/dynamic-framework/dynamic-ui/commit/9742eddc1ec7c8847b213383875a67c1844817ad))
* integrate Bootstrap icons style into DIcon component and update related documentation ([1b0f3d6](https://github.com/dynamic-framework/dynamic-ui/commit/1b0f3d6fa6fd333c0e5ba36b3b6abc64dd61f66a))
* light adjustment ([3f89303](https://github.com/dynamic-framework/dynamic-ui/commit/3f89303153cc2a437ceb8f7f99e6b1515eecba55))
* loading state on link variant ([0ba7735](https://github.com/dynamic-framework/dynamic-ui/commit/0ba773599897ff747ff77a4029902f5f402b00b5))
* master-detail refactor ([110273a](https://github.com/dynamic-framework/dynamic-ui/commit/110273a35188cd081970855d62d08bf915dd85fb))
* more examples ddropdown ([c8ccda2](https://github.com/dynamic-framework/dynamic-ui/commit/c8ccda2d78a2ee8dcd4fbe0cdda8bc4809ac179e))
* new component password strength meter ([#904](https://github.com/dynamic-framework/dynamic-ui/issues/904)) ([2fc93ea](https://github.com/dynamic-framework/dynamic-ui/commit/2fc93eae445cd8557905aec58ede60512165e322))
* new dbox component, adjustement buttons and dcreditcard props ([a97cb7e](https://github.com/dynamic-framework/dynamic-ui/commit/a97cb7e7db23ecb2db1324fb635cf5d2c3258578))
* new design ([b3f5502](https://github.com/dynamic-framework/dynamic-ui/commit/b3f55027d612ed81e2b34c27cf0b147efb96c629))
* new design datepicker, new patterns stories ([77e4ee4](https://github.com/dynamic-framework/dynamic-ui/commit/77e4ee44a11e13dc6772a3015b0e7b5fd8916bd4))
* new docs for ddropdown ([3e32881](https://github.com/dynamic-framework/dynamic-ui/commit/3e3288164ddec72366dd5adfc153fe00b0b1622c))
* patterns for dlistgroup ([d293c81](https://github.com/dynamic-framework/dynamic-ui/commit/d293c81dc5d9062f33af010b45713f494ccd5b0e))
* radialbar fix and card patterns on stories ([1f8e69c](https://github.com/dynamic-framework/dynamic-ui/commit/1f8e69c980c5f0c9cef8f1575c902d153524c310))
* refactor icons to lucide ([5b233bb](https://github.com/dynamic-framework/dynamic-ui/commit/5b233bb7cfe161bca956f9c6dc269ba4c6783a64))
* remove avatar variants, new design stepper ([1d47932](https://github.com/dynamic-framework/dynamic-ui/commit/1d4793292e515658c42ed04408dc6a92bb9667de))
* remove deprecated components ([b37900b](https://github.com/dynamic-framework/dynamic-ui/commit/b37900bdeb456e476aca97ed3712480aeb5da25d))
* remove deprecated props and adjust tests and stories ([7fe0380](https://github.com/dynamic-framework/dynamic-ui/commit/7fe03807ba0d8dcde69617242ac6029c2f9e8015))
* remove DTooltip color prop ([4212610](https://github.com/dynamic-framework/dynamic-ui/commit/4212610bcc819b3737cb43dfd42d9823489cdf6f))
* rollback md size ([5b458b2](https://github.com/dynamic-framework/dynamic-ui/commit/5b458b21c5558ffa39b3af60914e6a759774b54a))
* text-muted replacement, add max-with utilities ([55d84c3](https://github.com/dynamic-framework/dynamic-ui/commit/55d84c3b69e8cb41f5ce1e6a52e1fa93d42ce49d))
* timeline component ([c7cf808](https://github.com/dynamic-framework/dynamic-ui/commit/c7cf808ae4a44ba27188eb27ac9171eb08aa8669))
* update dependencies and migrate setup for storybook v9 ([#868](https://github.com/dynamic-framework/dynamic-ui/issues/868)) ([5dec343](https://github.com/dynamic-framework/dynamic-ui/commit/5dec3439f2406f91e6d3f2f32007bff03a25f83e))
* update dependencies and setup for react 19 ([#869](https://github.com/dynamic-framework/dynamic-ui/issues/869)) ([ec0b97c](https://github.com/dynamic-framework/dynamic-ui/commit/ec0b97c4442127078091abdd05c8d9960681ccfa))
* use only color states in toast hook and adjust stories and examples ([6d0823d](https://github.com/dynamic-framework/dynamic-ui/commit/6d0823df703850bd994e4a634cc4a986630a4174))
* utilities ajustements ([240fbe0](https://github.com/dynamic-framework/dynamic-ui/commit/240fbe0e36d9ed3236eb6de7c8901209f3bf2f4d))
* vertical mode ([060bbce](https://github.com/dynamic-framework/dynamic-ui/commit/060bbce443a2ed4b8d67a8b929a341080b9cd11b))


### Bug Fixes

* add readonly prop to DInput component for better input control ([62aa9b6](https://github.com/dynamic-framework/dynamic-ui/commit/62aa9b6c6704e7240d378a8600befad4f7a362e3))
* adjust duplicate color prop for text color using textColor as new prop ([a3e7b7a](https://github.com/dynamic-framework/dynamic-ui/commit/a3e7b7ae9505cd9aa50e78a399cbe67f787c5908))
* adjustments dinput stories ([33291aa](https://github.com/dynamic-framework/dynamic-ui/commit/33291aad178f7fddf6353e123e10ba5b0a7ba30a))
* badge size lg ([51f0933](https://github.com/dynamic-framework/dynamic-ui/commit/51f0933a088c2630fe5ac73b748da7db9c980ed8))
* codestyle and linter ([69e7ba2](https://github.com/dynamic-framework/dynamic-ui/commit/69e7ba28ea44bafa88bb2377ac9a15510f84d80b))
* correct icon casing in DBoxFile component ([c87bc90](https://github.com/dynamic-framework/dynamic-ui/commit/c87bc90a23118f531c8b0ca62a40c5aef7f891ca))
* correct parameter key from 'docs' to 'page' in QuickActionsPatterns story ([dc1b51a](https://github.com/dynamic-framework/dynamic-ui/commit/dc1b51a43bdbd885aea3ddab83a3047a7e781164))
* dashboard dlayout implementation ([425f0c3](https://github.com/dynamic-framework/dynamic-ui/commit/425f0c3ca988ff38d4eb45a12c3aa40220e69c60))
* **DBoxFile:** improve error messages with HTTP status and CORS detection ([d7f2e72](https://github.com/dynamic-framework/dynamic-ui/commit/d7f2e72951f67dcf05201f0c87ef45c0ccc85580))
* dcollapse icon size ([a9e20db](https://github.com/dynamic-framework/dynamic-ui/commit/a9e20dbe89a789c40ef2a32b96ac2c43dd7d1fec))
* **docs:** stories with internal icons ([8b5996c](https://github.com/dynamic-framework/dynamic-ui/commit/8b5996ce353f68e6799f0f32e484524152d8e2ca))
* extend correctly columns ([#897](https://github.com/dynamic-framework/dynamic-ui/issues/897)) ([07d7a44](https://github.com/dynamic-framework/dynamic-ui/commit/07d7a4431526750b75a58ae9472105a5d96309d9))
* hascircle bug ([2bad2cc](https://github.com/dynamic-framework/dynamic-ui/commit/2bad2ccc9f44d39768f5be7b2051c0ae213727ab))
* icon arrow left ([033fea4](https://github.com/dynamic-framework/dynamic-ui/commit/033fea494fc75d73610f3749d92e9eed449889a8))
* improve code readability by breaking long comments into multiple lines ([1e67db2](https://github.com/dynamic-framework/dynamic-ui/commit/1e67db2a8099de172760c2c7d13f4a5d6672432c))
* normalize buttons ([fb40f75](https://github.com/dynamic-framework/dynamic-ui/commit/fb40f7536c60ccf83759830579be6815d8df4f5f))
* normalize buttons ([aa9b022](https://github.com/dynamic-framework/dynamic-ui/commit/aa9b022f4404e463bf7455016c0460e7bf6d2bd7))
* remove deprecated mock ([#899](https://github.com/dynamic-framework/dynamic-ui/issues/899)) ([c660e8f](https://github.com/dynamic-framework/dynamic-ui/commit/c660e8fa31f8fe07e1d98088e133c88c26cb8246))
* remove doble prefix in dropdown padding x ([8d18e7b](https://github.com/dynamic-framework/dynamic-ui/commit/8d18e7b45bb45fa16be39952bc5a854b16598092))
* remove size prop on icon ([a60eec0](https://github.com/dynamic-framework/dynamic-ui/commit/a60eec02f672f078b106e08d4b54265bbfe023d6))
* remove unused pill prop ([612c118](https://github.com/dynamic-framework/dynamic-ui/commit/612c1189766902cd59cf6439ed310b47456112c9))
* remove wrapper on DListGroupItem ([9669639](https://github.com/dynamic-framework/dynamic-ui/commit/966963957fe98afa4cf30141fa038e233f35e55d))
* remove wrapper on DListGroupItem ([#918](https://github.com/dynamic-framework/dynamic-ui/issues/918)) ([9669639](https://github.com/dynamic-framework/dynamic-ui/commit/966963957fe98afa4cf30141fa038e233f35e55d))
* render test in DInputSwitch ([#903](https://github.com/dynamic-framework/dynamic-ui/issues/903)) ([9fb8803](https://github.com/dynamic-framework/dynamic-ui/commit/9fb88033b442810dcc659ca9aecef40d18a7577e))
* reorder doc tables and fixes ([7718087](https://github.com/dynamic-framework/dynamic-ui/commit/771808797c438d6054a697fe1adb69cb0be3b7b2))
* restore btn hover color ([dc415d7](https://github.com/dynamic-framework/dynamic-ui/commit/dc415d787f781a1736d6167acfd3ed94e6fbf652))
* some tests and refactor dinputpin ([660516d](https://github.com/dynamic-framework/dynamic-ui/commit/660516d6bb1e2d30f1c5c4619742894504c21e1a))
* stepper paddings, vars and icons ([c8302f4](https://github.com/dynamic-framework/dynamic-ui/commit/c8302f4dc9988d61daba60234ed5cc93b60eb9fa))
* update border property in _d-datepicker.scss for consistency ([b05296d](https://github.com/dynamic-framework/dynamic-ui/commit/b05296d80191f2e03ec65ea4fbcd3c77febff66e))
...
* **DBoxFile:** set custom behavior and new examples ([#813](https://github.com/dynamic-framework/dynamic-ui/issues/813)) ([80d74cb](https://github.com/dynamic-framework/dynamic-ui/commit/80d74cb8c313f4544223f55d5eb38445ec3c494e))
* **DDatepicker:** all API support on react-datepicker v8 ([#818](https://github.com/dynamic-framework/dynamic-ui/issues/818)) ([da0a064](https://github.com/dynamic-framework/dynamic-ui/commit/da0a064bbdee0a376dfc0c89775f608429f296a1))
* **DPopover:** remove deprecated state and update docs ([#792](https://github.com/dynamic-framework/dynamic-ui/issues/792)) ([b5f42a3](https://github.com/dynamic-framework/dynamic-ui/commit/b5f42a391fed95e323ed03360ec936453200a3a9))
* update react version and peer deps ([#799](https://github.com/dynamic-framework/dynamic-ui/issues/799)) ([244d3e9](https://github.com/dynamic-framework/dynamic-ui/commit/244d3e94d1bcabf4f411ad1b3f171e2585efab75))


### Bug Fixes

* add matchMedia property as global in jest ([#801](https://github.com/dynamic-framework/dynamic-ui/issues/801)) ([e6b2ed8](https://github.com/dynamic-framework/dynamic-ui/commit/e6b2ed8875fb8e21889948b40396d02b515e53d0))
* **DInput:** set icon size variables on sm and lg ([#807](https://github.com/dynamic-framework/dynamic-ui/issues/807)) ([f89effb](https://github.com/dynamic-framework/dynamic-ui/commit/f89effb90c80f13b0e4ce0ecf7d0a330176968ed))
* **DListGroupItem:** set button type as button ([#805](https://github.com/dynamic-framework/dynamic-ui/issues/805)) ([4fc27b8](https://github.com/dynamic-framework/dynamic-ui/commit/4fc27b89ae5efd9b47f2fa64cd20a79c71951305))
* **DPortalContext:** keep tab navigation inside active portal ([#811](https://github.com/dynamic-framework/dynamic-ui/issues/811)) ([64ab54d](https://github.com/dynamic-framework/dynamic-ui/commit/64ab54dcc5a1dd5cd75b0e49037478dc0507d1ac))
* **DToast:** add toast gap variable and set all variables in docs ([#806](https://github.com/dynamic-framework/dynamic-ui/issues/806)) ([c529e42](https://github.com/dynamic-framework/dynamic-ui/commit/c529e422fa8c37f202061dcd32544e543014356b))
* remove duplicated properties by scoping icon button ([#796](https://github.com/dynamic-framework/dynamic-ui/issues/796)) ([9b67890](https://github.com/dynamic-framework/dynamic-ui/commit/9b67890837383196543994bf1957e5971d731b2e))
* **style:** expose DInputSwitch css variables ([#803](https://github.com/dynamic-framework/dynamic-ui/issues/803)) ([4aa746a](https://github.com/dynamic-framework/dynamic-ui/commit/4aa746af1862b44184b491097dc1ebe678fd0307))
* **style:** remove fixed size and use min and max ([#798](https://github.com/dynamic-framework/dynamic-ui/issues/798)) ([4430932](https://github.com/dynamic-framework/dynamic-ui/commit/44309321d30385c3a43c67d6fe632c6630a0f630))
* **style:** remove padding from nav pills and underline ([#804](https://github.com/dynamic-framework/dynamic-ui/issues/804)) ([d8ce6b5](https://github.com/dynamic-framework/dynamic-ui/commit/d8ce6b5d8f6eb7de7774f37a0257f4c4abd23306))
* update hot toast version to 2.5.2 ([#808](https://github.com/dynamic-framework/dynamic-ui/issues/808)) ([decf2fa](https://github.com/dynamic-framework/dynamic-ui/commit/decf2fa94b4ca8b85a5dae3c8d79b67345f3fa45))
* update README.md ([#817](https://github.com/dynamic-framework/dynamic-ui/issues/817)) ([6bce4d2](https://github.com/dynamic-framework/dynamic-ui/commit/6bce4d228d2ddba5fa90970016b81fd93d9f5219))
* use input group color on validation ([#795](https://github.com/dynamic-framework/dynamic-ui/issues/795)) ([5efd629](https://github.com/dynamic-framework/dynamic-ui/commit/5efd62919b28b58d2993e0a12c49625c1b88cf1b))
...
* **DInputCheck:** add hint support ([8aa74dd](https://github.com/dynamic-framework/dynamic-ui/commit/8aa74dd4aeac54d850de421e3c82ac9f69f964d4))
