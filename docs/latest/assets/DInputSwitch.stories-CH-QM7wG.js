import{D as _}from"./DInputSwitch-DnPp3Zh4.js";import{P as e}from"./config-C3iYXcFk.js";import"./jsx-runtime-D_zvdyIk.js";import"./iframe-DFXAi8lp.js";import"./preload-helper-Dp1pzeXC.js";import"./index-C46YXI3i.js";const z={title:"Design System/Components/Input Switch",component:_,parameters:{docs:{description:{component:`
...
| --${e}form-check-input-focus-box-shadow     | .form-check-input   | css box shadow    | Focus box shadow           |
        `}}},argTypes:{id:{control:"text",type:"string",description:"The id of the input"},name:{control:"text",type:"string",description:"The name of the input"},className:{control:"text",type:"string",description:"The class name for the wrapper div"},style:{control:"object"},inputClassName:{control:"text",type:"string",description:"The class name for the input element"},label:{control:"text",type:"string"},checked:{control:"boolean",type:"boolean"},readonly:{control:"boolean",type:"boolean"},disabled:{control:"boolean",type:"boolean"},invalid:{control:"boolean",type:"boolean"},valid:{control:"boolean",type:"boolean"},onChange:{action:"onChange"}},tags:["autodocs"]},a={args:{checked:!1,disabled:!1,ariaLabel:"Label"}},o={args:{id:"componentId2",label:"Label",checked:!1,disabled:!1}},s={args:{id:"componentId3",label:"Label",checked:!1,disabled:!1,valid:!0}},t={args:{id:"componentId4",label:"Label",checked:!1,disabled:!1,invalid:!0}},r={args:{id:"componentId5",label:"Label",checked:!0,disabled:!1}},n={args:{id:"componentId6",label:"Label",checked:!1,readonly:!0}},c={args:{id:"componentId7",label:"Label",checked:!1,disabled:!0}},l={args:{id:"componentId8",label:"Label",checked:!0,disabled:!0}},d={args:{id:"componentId9",label:"Custom styled input",checked:!1,inputClassName:"border-2"}};var i,p,m;a.parameters={...a.parameters,docs:{...(i=a.parameters)==null?void 0:i.docs,source:{originalSource:`{
  args: {
    checked: false,
    disabled: false,
    ariaLabel: 'Label'
...
}`,...(k=(g=s.parameters)==null?void 0:g.docs)==null?void 0:k.source}}};var w,y,I;t.parameters={...t.parameters,docs:{...(w=t.parameters)==null?void 0:w.docs,source:{originalSource:`{
  args: {
    id: 'componentId4',
    label: 'Label',
    checked: false,
