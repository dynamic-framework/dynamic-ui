...
`}}},render:function(o){const[n,t]=s.useState(0),[a,d]=s.useState(!1);return e.jsxs("div",{className:"d-flex flex-column gap-2",children:[e.jsxs("div",{className:"d-flex gap-2",children:[e.jsx(c,{onClick:()=>d(!0),children:"Trigger error"}),e.jsx(c,{color:"secondary",onClick:()=>t(l=>l+1),children:"Change reset key"})]}),e.jsx(i,{...o,resetKeys:[n],children:e.jsx(m,{explode:a})})]})},args:{name:"WithResetKeys"}},y={parameters:{docs:{description:{story:"Adds name to tag logs and onError to extend logging or integrate with monitoring. Click “Trigger error” to see the event in Actions."},source:{code:`
function Bomb({ explode }: { explode: boolean }) {
  if (explode) throw new Error('Boom!');
  return (
    <DCard>
...
`}}},render:function(o){const[n,t]=s.useState(!1);return e.jsxs("div",{className:"d-flex flex-column gap-2",children:[e.jsx(c,{className:"me-auto",onClick:()=>t(!0),children:"Trigger error"}),e.jsx(i,{...o,onError:(a,d)=>{console.log({error:C(a),info:d})},name:"MyBoundary",children:e.jsx(m,{explode:n})})]})}},B={parameters:{docs:{description:{story:"Uses useErrorBoundary().showBoundary to surface an error without throwing, useful inside event handlers."},source:{code:`
...
}`,...(F=(K=g.parameters)==null?void 0:K.docs)==null?void 0:F.source}}};var V,M,W;y.parameters={...y.parameters,docs:{...(V=y.parameters)==null?void 0:V.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(J=(G=D.parameters)==null?void 0:G.docs)==null?void 0:J.source}}};const xe=["DefaultFallback","CustomFallback","WithResetKeys","WithNameAndOnError","UsingHookShowBoundary","DefaultFallbackAndOnReset","CustomFallbackAndOnReset"];export{x as CustomFallback,D as CustomFallbackAndOnReset,f as DefaultFallback,h as DefaultFallbackAndOnReset,B as UsingHookShowBoundary,y as WithNameAndOnError,g as WithResetKeys,xe as __namedExportsOrder,fe as default};
