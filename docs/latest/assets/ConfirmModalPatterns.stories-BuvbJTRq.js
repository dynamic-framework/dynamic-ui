import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as l}from"./iframe-CHeqVsUI.js";import{D}from"./DModal-DHKKWnxV.js";import{D as se}from"./DDropdown-KvfePTOU.js";import{D as v}from"./DOffcanvas-DJRvfmHd.js";import{D as g,u as i}from"./DConfirmModalContainer-XYM9LYHZ.js";import{D as y,a as x}from"./DContext-I2P6eEmu.js";import{D as s}from"./DButton-BGTbUgzt.js";import{D as b}from"./DInputSwitch-B6V2xRaQ.js";import{D as ne}from"./DAvatar-P4lKtRd7.js";import"./preload-helper-Dp1pzeXC.js";import"./index-9xGy8ok_.js";import"./config-C3iYXcFk.js";import"./DIcon-C9QpqnTB.js";import"./index-BPJnJB5S.js";import"./useMediaBreakpointUp-DWQi1yBD.js";import"./index-BGGRobhj.js";import"./index-C_Mg6fPP.js";import"./DButtonIcon-CMgOkkqu.js";import"./DInput-D1ASoflF.js";import"./useProvidedRefOrCreate-CTpffrae.js";const Fe={title:"Patterns/Confirm Modal",parameters:{layout:"centered"},decorators:[o=>e.jsxs(y,{children:[e.jsx(o,{}),e.jsx(g,{nodeId:"d-portal"})]})]};function re(){const[o,t]=l.useState(""),a=i({title:"Delete Item",message:"Are you sure you want to delete this item? This action cannot be undone.",confirmLabel:"Delete",cancelLabel:"Cancel",confirmColor:"danger",onConfirm:async()=>{await new Promise(n=>{setTimeout(n,1e3)}),t("Item deleted successfully")},onClose:()=>{t("Deletion cancelled")}});return e.jsxs("div",{className:"text-center",children:[e.jsx(s,{text:"Delete Item",color:"danger",onClick:a.open,className:"mb-3"}),o&&e.jsx("p",{className:"alert alert-info",children:o})]})}const d={render:()=>e.jsx(re,{}),parameters:{docs:{source:{code:`function SimpleConfirmContent() {
