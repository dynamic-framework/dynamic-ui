import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{useMDXComponents as l}from"./index-C6SlVEW6.js";import{M as d}from"./blocks-CG5owoJr.js";import"./iframe-vLNjGVop.js";import"./preload-helper-Dp1pzeXC.js";import"./index-DFPG5GmN.js";import"./index-oOcxeWdd.js";function n(i){const s={code:"code",h1:"h1",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...l(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(d,{title:"Design System/Foundations/Extended Utilities"}),`
...
`})}),e.jsx("br",{}),e.jsx(s.h3,{id:"animation-utilities",children:"Animation utilities"}),e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:[e.jsx(s.code,{children:".fade-in"})," — applies a quick opacity transition from ",e.jsx(s.code,{children:"0"})," to ",e.jsx(s.code,{children:"1"})," using ",e.jsx(s.code,{children:"ease-in-out"})," (duration: ",e.jsx(s.code,{children:"0.3s"}),")."]}),`
`]}),e.jsx(s.pre,{children:e.jsx(s.code,{className:"language-html",children:`<div class="fade-in">This content fades in on render</div>
`})}),e.jsx(s.p,{children:"Useful for conditionally rendered elements, modals, alerts, or any content that appears dynamically. The animation runs once on mount and does not loop."}),e.jsx("br",{}),e.jsx(s.h3,{id:"layout-component-dlayout",children:"Layout component (DLayout)"}),e.jsxs(s.p,{children:["For more advanced responsive grid layouts, the ",e.jsx(s.code,{children:"DLayout"})," component provides a declarative API on top of these CSS utilities, with customizable ",e.jsx(s.code,{children:"columns"})," and responsive ",e.jsx(s.code,{children:"gap*"})," props. Use ",e.jsx(s.code,{children:"DLayout.Pane"})," with responsive ",e.jsx(s.code,{children:"cols*"})," props to control individual pane widths, alongside standard ",e.jsx(s.code,{children:"className"}),", ",e.jsx(s.code,{children:"style"}),", and ",e.jsx(s.code,{children:"dataAttributes"})," support."]}),e.jsxs(s.p,{children:["See: ",e.jsx("a",{href:"/?path=/story/design-system-components-layout--default",children:"Design System/Components/Layout"}),"."]})]})]})}function p(i={}){const{wrapper:s}={...l(),...i.components};return s?e.jsx(s,{...i,children:e.jsx(n,{...i})}):n(i)}export{p as default};
