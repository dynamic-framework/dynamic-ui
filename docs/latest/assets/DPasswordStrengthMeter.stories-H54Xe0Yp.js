import{j as a}from"./jsx-runtime-D_zvdyIk.js";import{r as d}from"./iframe-vLNjGVop.js";import{F as _e}from"./DInputPassword-ByEauusc.js";import{c as T}from"./index-nyyuC_Uj.js";import{D as qe}from"./DIcon-BaYjXWaB.js";import"./preload-helper-Dp1pzeXC.js";import"./DInput-CimCsfpA.js";import"./useProvidedRefOrCreate-8yhSHKFF.js";import"./DContext-aUrSpq0p.js";import"./index-DFPG5GmN.js";import"./index-oOcxeWdd.js";import"./config-C3iYXcFk.js";import"./index-BPJnJB5S.js";import"./useMediaBreakpointUp-56XFbS_3.js";function V({password:r,regex:s,text:e}){const t=s.test(r);return a.jsxs("li",{className:"d-flex gap-2 align-items-start small text-gray-600",children:[a.jsx(qe,{className:T("flex-shrink-0",t?"text-success":"text-gray-300"),icon:t?"CircleCheck":"Circle",size:"16px"}),a.jsx("span",{className:T({"text-success":t}),children:e})]})}try{V.displayName="PasswordCheckItem",V.__docgenInfo={description:"",displayName:"PasswordCheckItem",props:{password:{defaultValue:null,description:"",name:"password",required:!0,type:{name:"string"}},regex:{defaultValue:null,description:"",name:"regex",required:!0,type:{name:"RegExp"}},text:{defaultValue:null,description:"",name:"text",required:!0,type:{name:"string"}}}}}catch{}const Ae=(r,s)=>{const e=s>0?r/s:0;return e===0?"bg-gray-200":e<=.25?"bg-danger":e<=.5?"bg-warning":e<=.75?"bg-info":"bg-success"};function Ve({strength:r,total:s}){const e=s>0?r/s*100:0;return a.jsx("div",{className:"w-100 rounded-3 overflow-hidden bg-gray-100 mb-2",style:{height:"8px"},children:a.jsx("div",{className:`h-100 ${Ae(r,s)}`,style:{width:`${e}%`,transition:"width 0.3s ease-in-out"}})})}try{PasswordStrength.displayName="PasswordStrength",PasswordStrength.__docgenInfo={description:"",displayName:"PasswordStrength",props:{strength:{defaultValue:null,description:"",name:"strength",required:!0,type:{name:"number"}},total:{defaultValue:null,description:"",name:"total",required:!0,type:{name:"number"}}}}}catch{}const c={uppercase:/[A-Z]/,lowercase:/[a-z]/,number:/\d/,specialChar:/[~!@#$^*\-_=[\]{}|;,.?]/};function Me({password:r,validationMessages:s,enabledChecks:e}){const n=[{key:"uppercase",regex:c.uppercase,text:s.uppercaseLetter},{key:"lowercase",regex:c.lowercase,text:s.lowercaseLetter},{key:"number",regex:c.number,text:s.number},{key:"specialChar",regex:c.specialChar,text:s.especialChar}].filter(o=>e.includes(o.key)),P=n.filter(o=>o.regex.test(r)).length,S=n.length;return a.jsxs("div",{className:"mt-2",children:[a.jsx(Ve,{strength:P,total:S}),a.jsx("ul",{className:"list-unstyled m-0 d-flex flex-column gap-2",children:n.map(({key:o,regex:_,text:q})=>a.jsx(V,{password:r,regex:_,text:q},o))})]})}try{PasswordCheckList.displayName="PasswordCheckList",PasswordCheckList.__docgenInfo={description:"",displayName:"PasswordCheckList",props:{password:{defaultValue:null,description:"",name:"password",required:!0,type:{name:"string"}},validationMessages:{defaultValue:null,description:"",name:"validationMessages",required:!0,type:{name:"ValidationMessages"}},enabledChecks:{defaultValue:null,description:"",name:"enabledChecks",required:!0,type:{name:"ValidationCheck[]"}}}}}catch{}const Ne={number:"At least one number",lowercaseLetter:"At least one lowercase letter",uppercaseLetter:"At least one uppercase letter",especialChar:"At least one of these special characters: ~!@#$^*-_=[]{}|;,.?",notMatch:"The password confirmation and the new password do not match."},Le=["uppercase","lowercase","number","specialChar"];function l({id:r,label:s="Password",placeholder:e,value:t="",name:n,disabled:P=!1,invalid:S=!1,validationMessages:o=Ne,enabledChecks:_=Le,className:q,style:ke,dataAttributes:xe,onChange:A,readonly:Pe=!1}){const[M,N]=d.useState(t);d.useEffect(()=>{N(t)},[t]);const Se=L=>{N(L),A==null||A(L)};return a.jsxs("div",{className:q,style:ke,...xe,children:[a.jsx(_e,{id:r,label:s,placeholder:e,value:M,name:n,disabled:P,invalid:S,onChange:Se,readonly:Pe}),a.jsx(Me,{password:M,validationMessages:o,enabledChecks:_})]})}try{l.displayName="DPasswordStrengthMeter",l.__docgenInfo={description:"",displayName:"DPasswordStrengthMeter",props:{style:{defaultValue:null,description:"",name:"style",required:!1,type:{name:"CSSProperties | undefined"}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string | undefined"}},dataAttributes:{defaultValue:null,description:"",name:"dataAttributes",required:!1,type:{name:"DataAttributes | undefined"}},id:{defaultValue:null,description:"",name:"id",required:!1,type:{name:"string | undefined"}},label:{defaultValue:{value:"Password"},description:"",name:"label",required:!1,type:{name:"string | undefined"}},placeholder:{defaultValue:null,description:"",name:"placeholder",required:!1,type:{name:"string | undefined"}},value:{defaultValue:{value:""},description:"",name:"value",required:!1,type:{name:"string | undefined"}},name:{defaultValue:null,description:"",name:"name",required:!1,type:{name:"string | undefined"}},disabled:{defaultValue:{value:"false"},description:"",name:"disabled",required:!1,type:{name:"boolean | undefined"}},invalid:{defaultValue:{value:"false"},description:"",name:"invalid",required:!1,type:{name:"boolean | undefined"}},validationMessages:{defaultValue:{value:`{
...
}`,...($=(U=p.parameters)==null?void 0:U.docs)==null?void 0:$.source}}};var W,z,B;m.parameters={...m.parameters,docs:{...(W=m.parameters)==null?void 0:W.docs,source:{originalSource:`{
  args: {
    id: 'password4',
    label: 'Password',
    value: 'Test123!',
...
}`,...(B=(z=m.parameters)==null?void 0:z.docs)==null?void 0:B.source}}};var Z,G,H;h.parameters={...h.parameters,docs:{...(Z=h.parameters)==null?void 0:Z.docs,source:{originalSource:`{
  args: {
    id: 'password5',
    label: 'Password',
    invalid: true
  }
}`,...(H=(G=h.parameters)==null?void 0:G.docs)==null?void 0:H.source}}};var K,X,Y;g.parameters={...g.parameters,docs:{...(K=g.parameters)==null?void 0:K.docs,source:{originalSource:`{
  args: {
    id: 'password6',
    label: 'Password',
    value: 'Test123!',
...
}`,...(ee=(Q=w.parameters)==null?void 0:Q.docs)==null?void 0:ee.source}}};var ae,se,re;b.parameters={...b.parameters,docs:{...(ae=b.parameters)==null?void 0:ae.docs,source:{originalSource:`{
...
}`,...(re=(se=b.parameters)==null?void 0:se.docs)==null?void 0:re.source}}};var te,ne,oe;y.parameters={...y.parameters,docs:{...(te=y.parameters)==null?void 0:te.docs,source:{originalSource:`{
  args: {
    id: 'password9',
    label: 'Contraseña',
...
}`,...(oe=(ne=y.parameters)==null?void 0:ne.docs)==null?void 0:oe.source}}};var le,de,ce;f.parameters={...f.parameters,docs:{...(le=f.parameters)==null?void 0:le.docs,source:{originalSource:`{
...
}`,...(ce=(de=f.parameters)==null?void 0:de.docs)==null?void 0:ce.source}}};var ie,ue,pe;C.parameters={...C.parameters,docs:{...(ie=C.parameters)==null?void 0:ie.docs,source:{originalSource:`{
  args: {
    id: 'password11',
...
}`,...(ge=(he=v.parameters)==null?void 0:he.docs)==null?void 0:ge.source}}};var we,be,ye;k.parameters={...k.parameters,docs:{...(we=k.parameters)==null?void 0:we.docs,source:{originalSource:`{
  args: {
    id: 'password13',
    label: 'Very Simple Password',
...
}`,...(ye=(be=k.parameters)==null?void 0:be.docs)==null?void 0:ye.source}}};var fe,Ce,ve;x.parameters={...x.parameters,docs:{...(fe=x.parameters)==null?void 0:fe.docs,source:{originalSource:`{
...
}`,...(ve=(Ce=x.parameters)==null?void 0:Ce.docs)==null?void 0:ve.source}}};const He=["Default","WithValue","CustomLabel","Disabled","Invalid","Readonly","Interactive","WithFeedback","CustomMessages","CustomMessagesInteractive","OnlyThreeChecks","OnlyTwoChecks","OnlyOneCheck","CustomChecksInteractive"];export{x as CustomChecksInteractive,p as CustomLabel,y as CustomMessages,f as CustomMessagesInteractive,i as Default,m as Disabled,w as Interactive,h as Invalid,k as OnlyOneCheck,C as OnlyThreeChecks,v as OnlyTwoChecks,g as Readonly,b as WithFeedback,u as WithValue,He as __namedExportsOrder,Ge as default};
