import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as l}from"./iframe-DkjceUUU.js";import{D}from"./DModal-SS9JuWXl.js";import{D as se}from"./DDropdown-DukZd6cv.js";import{D as v}from"./DOffcanvas-B2tlYFUX.js";import{D as g,u as i}from"./DConfirmModalContainer-0I5wZW_m.js";import{D as y,a as x}from"./DContext-BbaizxMa.js";import{D as s}from"./DButton-BUrFSCCL.js";import{D as b}from"./DInputSwitch-CulmH4fK.js";import{D as ne}from"./DAvatar-DqSxqLQ9.js";import"./preload-helper-Dp1pzeXC.js";import"./index-CtlKHQhD.js";import"./config-C3iYXcFk.js";import"./DIcon-CBkIH7ym.js";import"./useMediaBreakpointUp-C9viAbpR.js";import"./index-p6Xuepxi.js";import"./index-DxZ9-uFP.js";import"./DButtonIcon-CHyF0fNe.js";import"./DInput-BcmlNBIB.js";import"./useProvidedRefOrCreate-S-lUNZjQ.js";const Re={title:"Patterns/Confirm Modal",parameters:{layout:"centered"},decorators:[o=>e.jsxs(y,{children:[e.jsx(o,{}),e.jsx(g,{nodeId:"d-portal"})]})]};function re(){const[o,t]=l.useState(""),a=i({title:"Delete Item",message:"Are you sure you want to delete this item? This action cannot be undone.",confirmLabel:"Delete",cancelLabel:"Cancel",confirmColor:"danger",onConfirm:async()=>{await new Promise(n=>{setTimeout(n,1e3)}),t("Item deleted successfully")},onClose:()=>{t("Deletion cancelled")}});return e.jsxs("div",{className:"text-center",children:[e.jsx(s,{text:"Delete Item",color:"danger",onClick:a.open,className:"mb-3"}),o&&e.jsx("p",{className:"alert alert-info",children:o})]})}const d={render:()=>e.jsx(re,{}),parameters:{docs:{source:{code:`function SimpleConfirmContent() {
