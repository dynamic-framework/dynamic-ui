...
}`,...(I=(z=p.parameters)==null?void 0:z.docs)==null?void 0:I.source},description:{story:"Terms acceptance block with switch on the left, subtle border container,\nand a trailing check icon that appears when accepted using CSS `:has()`.",...(L=(E=p.parameters)==null?void 0:E.docs)==null?void 0:L.description}}};const te=["NotificationPreferences","FeatureCards","PrivacySettings","TermsAndConditionsCard"];export{d as FeatureCards,o as NotificationPreferences,l as PrivacySettings,p as TermsAndConditionsCard,te as __namedExportsOrder,ae as default};
