import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{D as s}from"./DLayout-Cf88J_d7.js";import{D as o}from"./DBox-CSO5ECf7.js";import"./index-ehdBXeXN.js";import"./iframe-BMeNOU03.js";import"./preload-helper-Dp1pzeXC.js";const _={title:"Design System/Components/Layout",component:s,argTypes:{gap:{control:{type:"select"},options:[0,1,2,3,4,5],description:"Gap spacing between columns (all breakpoints)",table:{category:"Appearance"}},gapSm:{control:{type:"select"},options:[0,1,2,3,4,5],description:"Gap spacing for small screens (≥576px)",table:{category:"Appearance"}},gapMd:{control:{type:"select"},options:[0,1,2,3,4,5],description:"Gap spacing for medium screens (≥768px)",table:{category:"Appearance"}},gapLg:{control:{type:"select"},options:[0,1,2,3,4,5],description:"Gap spacing for large screens (≥992px)",table:{category:"Appearance"}},gapXl:{control:{type:"select"},options:[0,1,2,3,4,5],description:"Gap spacing for extra large screens (≥1200px)",table:{category:"Appearance"}},gapXxl:{control:{type:"select"},options:[0,1,2,3,4,5],description:"Gap spacing for extra extra large screens (≥1400px)",table:{category:"Appearance"}},children:{table:{type:{summary:"ReactNode"},category:"Content"},control:!1},className:{type:"string",table:{category:"Appearance"}}},parameters:{docs:{description:{component:`
...
}`,...(D=(g=n.parameters)==null?void 0:g.docs)==null?void 0:D.source}}};var y,j,P;r.parameters={...r.parameters,docs:{...(y=r.parameters)==null?void 0:y.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(P=(j=r.parameters)==null?void 0:j.docs)==null?void 0:P.source}}};var L,f,B;t.parameters={...t.parameters,docs:{...(L=t.parameters)==null?void 0:L.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(T=(G=i.parameters)==null?void 0:G.docs)==null?void 0:T.source}}};var k,R,z;p.parameters={...p.parameters,docs:{...(k=p.parameters)==null?void 0:k.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(z=(R=p.parameters)==null?void 0:R.docs)==null?void 0:z.source}}};var I,W,A;d.parameters={...d.parameters,docs:{...(I=d.parameters)==null?void 0:I.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(A=(W=d.parameters)==null?void 0:W.docs)==null?void 0:A.source}}};const K=["Default","ThreeColumns","Sidebar","ComplexLayout","WithGap","Responsive","ResponsiveGap","FiveColumns","TwentyFourColumns"];export{t as ComplexLayout,a as Default,p as FiveColumns,l as Responsive,i as ResponsiveGap,r as Sidebar,n as ThreeColumns,d as TwentyFourColumns,c as WithGap,K as __namedExportsOrder,_ as default};
