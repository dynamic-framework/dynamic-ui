import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as l}from"./iframe-vLNjGVop.js";import{D}from"./DModal-DQJnMGr4.js";import{D as se}from"./DDropdown-z_mMG3Fb.js";import{D as v}from"./DOffcanvas-DVZ4A-eL.js";import{D as g,u as i}from"./DConfirmModalContainer-B2bEQ-9U.js";import{D as y,a as x}from"./DContext-aUrSpq0p.js";import{D as s}from"./DButton-k5jVOt40.js";import{D as b}from"./DInputSwitch-BMtaDD7q.js";import{D as ne}from"./DAvatar-BgN1m99j.js";import"./preload-helper-Dp1pzeXC.js";import"./index-nyyuC_Uj.js";import"./config-C3iYXcFk.js";import"./DIcon-BaYjXWaB.js";import"./index-BPJnJB5S.js";import"./useMediaBreakpointUp-56XFbS_3.js";import"./index-DFPG5GmN.js";import"./index-oOcxeWdd.js";import"./DButtonIcon-Ctjyzj7-.js";import"./DInput-CimCsfpA.js";import"./useProvidedRefOrCreate-8yhSHKFF.js";const Fe={title:"Patterns/Confirm Modal",parameters:{layout:"centered"},decorators:[o=>e.jsxs(y,{children:[e.jsx(o,{}),e.jsx(g,{nodeId:"d-portal"})]})]};function re(){const[o,t]=l.useState(""),a=i({title:"Delete Item",message:"Are you sure you want to delete this item? This action cannot be undone.",confirmLabel:"Delete",cancelLabel:"Cancel",confirmColor:"danger",onConfirm:async()=>{await new Promise(n=>{setTimeout(n,1e3)}),t("Item deleted successfully")},onClose:()=>{t("Deletion cancelled")}});return e.jsxs("div",{className:"text-center",children:[e.jsx(s,{text:"Delete Item",color:"danger",onClick:a.open,className:"mb-3"}),o&&e.jsx("p",{className:"alert alert-info",children:o})]})}const d={render:()=>e.jsx(re,{}),parameters:{docs:{source:{code:`function SimpleConfirmContent() {
...
the discard confirmation on top of the already-open offcanvas.`,...(ae=(te=C.parameters)==null?void 0:te.docs)==null?void 0:ae.description}}};const Ke=["SimpleConfirm","CriticalDelete","DeleteContact","MultipleActions","ContactList","ConfirmOnModal","ConfirmOnOffcanvas"];export{h as ConfirmOnModal,C as ConfirmOnOffcanvas,p as ContactList,m as CriticalDelete,f as DeleteContact,u as MultipleActions,d as SimpleConfirm,Ke as __namedExportsOrder,Fe as default};
