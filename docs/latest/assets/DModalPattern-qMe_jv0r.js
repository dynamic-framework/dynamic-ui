...
`]}),`
`,e.jsx(i,{title:"Design System/Components/Modal/Usage"}),`
...
then be opened with the `,e.jsx(o.code,{children:"useDPortalContext"}),` hook. The payload type of the modals
...
return (
  ...
  `,language:"tsx",dark:!0}),`
`,e.jsx(c,{children:e.jsx("div",{className:"d-flex flex-column justify-content-end align-items-end",children:e.jsx(h,{})})})]})}function N(a={}){const{wrapper:o}={...s(),...a.components};return o?e.jsx(o,{...a,children:e.jsx(n,{...a})}):n(a)}export{N as default};
