import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{M as G}from"./Template-D-nHb7zw.js";import{r as l}from"./iframe-vLNjGVop.js";import{D as U}from"./DBox-Cmf34cPu.js";import{a as i}from"./DListGroup-CwjB8VBd.js";import{D as Y}from"./DIcon-BaYjXWaB.js";import{D as q}from"./DDropdown-z_mMG3Fb.js";import{D as b}from"./DButtonIcon-Ctjyzj7-.js";import"./index-C6SlVEW6.js";import"./blocks-CG5owoJr.js";import"./preload-helper-Dp1pzeXC.js";import"./index-DFPG5GmN.js";import"./index-oOcxeWdd.js";import"./index-nyyuC_Uj.js";import"./index-BPJnJB5S.js";import"./config-C3iYXcFk.js";import"./useMediaBreakpointUp-56XFbS_3.js";import"./DContext-aUrSpq0p.js";function h({actionsWidth:n,openThreshold:t}){const[s,d]=l.useState(null),[a,R]=l.useState(null),[y,u]=l.useState(0),D=l.useRef(0),m=l.useRef(0),_=o=>a===o?y:s===o?-n:0,A=o=>a===o,w=()=>{d(null)},f=o=>{d(o)},X=(o,r)=>{R(o),D.current=r,m.current=s===o?-n:0,u(m.current),s&&s!==o&&d(null)},K=o=>{if(!a)return;const r=o-D.current,$=Math.max(-n,Math.min(0,m.current+r));u($)},S=()=>{if(!a)return;const o=Math.abs(y)>t;d(o?a:null),R(null),u(0)};return{closeRow:w,getKeyboardHandler:o=>r=>{r.key==="ArrowLeft"&&f(o),(r.key==="ArrowRight"||r.key==="Escape")&&w(),(r.key==="Enter"||r.key===" ")&&(r.preventDefault(),s===o?w():f(o))},getPointerHandlers:o=>({onPointerDown:r=>{r.currentTarget.setPointerCapture(r.pointerId),X(o,r.clientX)},onPointerMove:r=>{r.currentTarget.hasPointerCapture(r.pointerId)&&K(r.clientX)},onPointerUp:r=>{r.currentTarget.hasPointerCapture(r.pointerId)&&r.currentTarget.releasePointerCapture(r.pointerId),S()},onPointerCancel:r=>{r.currentTarget.hasPointerCapture(r.pointerId)&&r.currentTarget.releasePointerCapture(r.pointerId),S()}}),getTranslateX:_,isDragging:A,openRow:f,openRowId:s}}const I=[{id:"tx-1",title:"Netflix subscription",subtitle:"Today, 9:45 AM",amount:"-$17.99"},{id:"tx-2",title:"Coffee Store",subtitle:"Today, 8:02 AM",amount:"-$4.50"},{id:"tx-3",title:"Incoming transfer",subtitle:"Yesterday, 7:31 PM",amount:"+$1,250.00"},{id:"tx-4",title:"Electric bill",subtitle:"Yesterday, 12:14 PM",amount:"-$86.30"}],Ie={title:"Patterns/Mobile/List Item Swipe Actions",component:U,parameters:{docs:{page:G,description:{component:"Mobile swipe actions pattern for transactional lists. Swipe each row to reveal contextual actions while keeping a single opened row at a time."}}},tags:["autodocs"]};function x({children:n}){return e.jsx("div",{className:"bg-gray-25 border position-relative overflow-hidden rounded-2",style:{width:"390px",maxWidth:"100%",height:"760px"},children:n})}const O=168,v=56,B=String.raw`import {
  useRef,
  useState,
  type KeyboardEvent,
  type PointerEvent,
...
}`,...(M=(W=p.parameters)==null?void 0:W.docs)==null?void 0:M.source}}};const xe=["Default","IconOnlyActions","ActionsWithDropdown"];export{p as ActionsWithDropdown,c as Default,g as IconOnlyActions,xe as __namedExportsOrder,Ie as default};
