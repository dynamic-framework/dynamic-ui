import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{useMDXComponents as l}from"./index-DOE-a7Qz.js";import{M as j,k as f,U as w}from"./blocks-CRrI9CLz.js";import{r as s}from"./iframe-B_Y9M-l-.js";import{D as o}from"./DCard-MlWwPbFj.js";import{D as y}from"./DButton-CzgpYs-b.js";import"./preload-helper-Dp1pzeXC.js";import"./index-Cnk-UfrQ.js";import"./index-BwYFOMBQ.js";import"./index-72Ch5-Y2.js";import"./DIcon-Db41hg1i.js";import"./index-BPJnJB5S.js";import"./config-7dXXkQRG.js";import"./useMediaBreakpointUp-C7_Y8Dh0.js";import"./DContext-CWByZeTV.js";const h="(min-width: 768px)";function b(){const n=s.useRef(null),t=s.useRef(null),[m,c]=s.useState(0),[d,u]=s.useState();s.useEffect(()=>{const i=n.current;if(!i)return;c(i.getBoundingClientRect().width);const r=new ResizeObserver(([p])=>{c(p.contentRect.width)});return r.observe(i),()=>r.disconnect()},[]);const x=()=>{var r;const i=(r=t.current)==null?void 0:r.contentWindow;u(i?i.matchMedia(h).matches:void 0)};return e.jsxs(o,{children:[e.jsx(o.Header,{children:h}),e.jsxs(o.Body,{children:[e.jsx("p",{className:"mb-2",children:'Drag the right edge to resize the box (an isolated viewport), then click "Check now" to read the match at that instant.'}),e.jsxs("div",{ref:n,style:{position:"relative",resize:"horizontal",overflow:"hidden",border:"1px solid var(--bs-border-color)",width:900,maxWidth:"100%",minWidth:320,height:48},children:[e.jsx("iframe",{ref:t,title:"checkMediaQuery resizable preview",style:{width:"100%",height:"100%",border:"none"}}),e.jsx("span",{className:"badge text-bg-dark",style:{position:"absolute",top:4,left:4},children:`Width: ${Math.round(m)}px`})]}),e.jsxs("div",{className:"d-flex align-items-center gap-3 mt-3",children:[e.jsx(y,{size:"sm",onClick:x,text:"Check now"}),e.jsx("pre",{className:"mb-0",children:d===void 0?"Matches: (not checked yet)":`Matches: ${d}`})]})]})]})}function g(){return e.jsx(b,{})}function a(n){const t={blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",li:"li",p:"p",strong:"strong",ul:"ul",...l(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(j,{title:"Design System/Utils/mediaQuery/checkMediaQuery"}),`
