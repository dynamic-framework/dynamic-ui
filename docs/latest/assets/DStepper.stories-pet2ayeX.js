...
}`,...(N=(A=a.parameters)==null?void 0:A.docs)==null?void 0:N.source},description:{story:"To use Stepper with Material Symbols style use a `DContextProvider` with `familyClass`\nand the flag `materialStyle=true` or use the flags directly over the\n`DStepper` component as a props",...(P=(I=a.parameters)==null?void 0:I.docs)==null?void 0:P.description}}};const ie=["Default","DefaultMobile","Vertical","WithDescription","WithDescriptionVertical","MaterialStyle"];export{s as Default,o as DefaultMobile,a as MaterialStyle,i as Vertical,n as WithDescription,l as WithDescriptionVertical,ie as __namedExportsOrder,oe as default};
