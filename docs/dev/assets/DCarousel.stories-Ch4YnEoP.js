import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{D as i}from"./DCarousel-DnkQCf65.js";import{P as n}from"./config-C3iYXcFk.js";import"./iframe-BFBKoHXE.js";import"./index-Cz4ROImR.js";const P={title:"Design System/Components/Carousel",component:i,parameters:{docs:{description:{component:`
...
}`,...(p=(u=r.parameters)==null?void 0:u.docs)==null?void 0:p.source}}};var c,m,g;t.parameters={...t.parameters,docs:{...(c=t.parameters)==null?void 0:c.docs,source:{originalSource:`{
  render: args => <DCarousel {...args}>
      {[1, 2, 3, 4, 5].map(el => <DCarousel.Slide key={el}>
          <div className="d-flex flex-column bg-light border p-3 rounded text-center">
            <h5>{\`Slide \${el}\`}</h5>
...
}`,...(S=(v=l.parameters)==null?void 0:v.docs)==null?void 0:S.source}}};const q=["Default","TwoPerPage","WithBreakpoints","AutoplayAndLoop"];export{l as AutoplayAndLoop,r as Default,t as TwoPerPage,s as WithBreakpoints,q as __namedExportsOrder,P as default};
