import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{P as s}from"./config-C3iYXcFk.js";import{D as i}from"./DIcon-DXPiC-z7.js";import{T as ae,I as ce,a as f}from"./constants-CyI_OqvZ.js";import{F as h}from"./DInput-Bq9Zzv_H.js";import{D as a}from"./DContext-DOX3qxCU.js";import"./index-CHSBDdIb.js";import"./iframe-B6LdZuKn.js";import"./preload-helper-Dp1pzeXC.js";import"./useMediaBreakpointUp-BwNKVy9w.js";import"./useProvidedRefOrCreate-D_Nry6WU.js";import"./index-BTHOX6mp.js";import"./index-CLtHUTcp.js";const je={title:"Design System/Components/Icon",component:i,parameters:{docs:{description:{component:`
...
| \`.d-icon-has-circle\` | Enables circle background and default opacity variable \`--${s}icon-component-bg-opacity\` | \`hasCircle\` prop |
...
|--------------------------------------|----------------------|-----------------|------------------------------------------------|
| --${s}icon-component-size    | .d-icon              | css length unit | Icon size                                       |
| --${s}icon-component-padding | .d-icon              | css length unit | Padding for circle background                   |
| --${s}icon-component-color   | .d-icon/.d-icon-color-* | css color unit  | Icon color (set via class)                      |
| --${s}icon-component-bg-color | .d-icon/.d-icon-has-circle | css color unit  | Circle background color (set via class)         |
| --${s}icon-component-bg-opacity | .d-icon-has-circle | number          | Opacity used in circle bg (default \`.1\`)     |
...
}`,...(A=(T=p.parameters)==null?void 0:T.docs)==null?void 0:A.source}}};var b,w,k;d.parameters={...d.parameters,docs:{...(b=d.parameters)==null?void 0:b.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    gap: '24px',
    flexWrap: 'wrap',
...
}`,...(k=(w=d.parameters)==null?void 0:w.docs)==null?void 0:k.source}}};var W,M,P;x.parameters={...x.parameters,docs:{...(W=x.parameters)==null?void 0:W.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    gap: '24px',
    flexWrap: 'wrap',
...
}`,...(N=(H=m.parameters)==null?void 0:H.docs)==null?void 0:N.source}}};var R,_,B;g.parameters={...g.parameters,docs:{...(R=g.parameters)==null?void 0:R.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(B=(_=g.parameters)==null?void 0:_.docs)==null?void 0:B.source}}};var L,O,U,V,F;r.parameters={...r.parameters,docs:{...(L=r.parameters)==null?void 0:L.docs,source:{originalSource:`{
...
}`,...(U=(O=r.parameters)==null?void 0:O.docs)==null?void 0:U.source},description:{story:"To use icons with Material Symbols style configuration use the `materialStyle` prop\nor configure globally via `DContextProvider`",...(F=(V=r.parameters)==null?void 0:V.docs)==null?void 0:F.description}}};var G,X,$;y.parameters={...y.parameters,docs:{...(G=y.parameters)==null?void 0:G.docs,source:{originalSource:`{
  render: (args: ComponentProps<typeof DIcon>) => <DContextProvider {...CONTEXT_PROVIDER_CONFIG_MATERIAL}>
      <div style={{
      display: 'flex',
      gap: '24px',
...
}`,...($=(X=y.parameters)==null?void 0:X.docs)==null?void 0:$.source}}};var q,J,K,Q,Y;n.parameters={...n.parameters,docs:{...(q=n.parameters)==null?void 0:q.docs,source:{originalSource:`{
...
}`,...(oe=(ne=v.parameters)==null?void 0:ne.docs)==null?void 0:oe.source}}};const Ie=["Default","CommonIcons","WithColors","WithCircle","StrokeWidthVariants","Sizes","WithResponsiveSizes","MaterialDesignIcons","MaterialDesignIconsWithCircle","MaterialDesignInComponents","BootstrapIconsStyle","CustomColorClasses"];export{o as BootstrapIconsStyle,l as CommonIcons,v as CustomColorClasses,c as Default,r as MaterialDesignIcons,y as MaterialDesignIconsWithCircle,n as MaterialDesignInComponents,m as Sizes,x as StrokeWidthVariants,d as WithCircle,p as WithColors,g as WithResponsiveSizes,Ie as __namedExportsOrder,je as default};
