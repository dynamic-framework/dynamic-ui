...
}`,...(P=(N=s.parameters)==null?void 0:N.docs)==null?void 0:P.source},description:{story:"To use Stepper with Material Symbols style use a `DContextProvider` with `familyClass`\nand the flag `materialStyle=true` or use the flags directly over the\n`DStepper` component as a props",...(q=(A=s.parameters)==null?void 0:A.docs)==null?void 0:q.description}}};const ie=["Default","DefaultMobile","Vertical","WithDescription","WithDescriptionVertical","MaterialStyle"];export{a as Default,i as DefaultMobile,s as MaterialStyle,o as Vertical,n as WithDescription,l as WithDescriptionVertical,ie as __namedExportsOrder,ae as default};
