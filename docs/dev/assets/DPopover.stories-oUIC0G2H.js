import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as d}from"./iframe-XnRhdyHW.js";import{c as D}from"./index-D0sKC-UO.js";import{u as M,a as z,b as X,c as J,d as U,e as G,F as H}from"./floating-ui.react-BjL_85rM.js";import{P as K}from"./config-BV4l-vIF.js";import{b as L}from"./floating-ui.dom-osFzHgfv.js";import{o as Q,f as W,s as Y}from"./floating-ui.react-dom-58du_pUC.js";import{D as Z}from"./DButton-DLoc9Exd.js";import{D as c}from"./DCard-DSAuvsVU.js";function n({children:o,renderComponent:u,open:m,setOpen:p,adjustContentToRender:l=!1,className:E,style:f,dataAttributes:N}){const[i,C]=d.useState(!1);d.useEffect(()=>{C(m)},[m]);const k=d.useCallback(g=>{C(g),p&&p(g)},[p]),{refs:v,floatingStyles:F,context:s}=M({open:i,onOpenChange:k,middleware:[Q(0),W({fallbackAxisSideDirection:"none"}),Y()],whileElementsMounted:L}),T=z(s),V=X(s),q=J(s),{getReferenceProps:A,getFloatingProps:I}=U([T,V,q]),O=G(),$=d.useMemo(()=>({...f,...l&&{[`--${K}popover-component-min-width`]:"auto"}}),[f,l]);return e.jsxs("div",{className:D("d-popover",E),style:$,...N,children:[e.jsx("div",{ref:v.setReference,...A(),children:u(i)}),i&&e.jsx(H,{context:s,modal:!1,children:e.jsx("div",{className:D("d-popover-content",{"w-100":l}),ref:v.setFloating,style:F,"aria-labelledby":O,...I(),children:o})})]})}try{n.displayName="DPopover",n.__docgenInfo={description:"",displayName:"DPopover",props:{style:{defaultValue:null,description:"",name:"style",required:!1,type:{name:"CSSProperties | undefined"}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string | undefined"}},dataAttributes:{defaultValue:null,description:"",name:"dataAttributes",required:!1,type:{name:"DataAttributes | undefined"}},renderComponent:{defaultValue:null,description:`Component to render in call to action
@param open
@returns`,name:"renderComponent",required:!0,type:{name:"(open: boolean) => ReactElement<unknown, string | JSXElementConstructor<any>>"}},open:{defaultValue:null,description:"",name:"open",required:!0,type:{name:"boolean"}},setOpen:{defaultValue:null,description:"",name:"setOpen",required:!1,type:{name:"((open: boolean) => void) | undefined"}},adjustContentToRender:{defaultValue:{value:"false"},description:"",name:"adjustContentToRender",required:!1,type:{name:"boolean | undefined"}}}}}catch{}const ee={title:"Design System/Patterns/Popover",component:n,argTypes:{className:{control:"text",type:"string"},style:{control:"object"},adjustContentToRender:{control:"boolean",type:"boolean"}},decorators:[o=>e.jsx("div",{style:{height:"250px"},className:"d-flex justify-content-center align-items-center",children:e.jsx(o,{})})]};function w(o){return e.jsx(Z,{className:"w-100",text:"Popover on bottom",iconEnd:`${o?"chevron-up":"chevron-down"}`,stopPropagationEnabled:!1})}function R(o,u){return`
