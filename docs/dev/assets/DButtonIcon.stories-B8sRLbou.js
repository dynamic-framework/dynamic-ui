import{j as s}from"./jsx-runtime-D_zvdyIk.js";import{D as S}from"./DButtonIcon-BGtX_9jv.js";import{P as t}from"./config-C3iYXcFk.js";import{b as A,I as C,c as _,T as I,a as T}from"./constants-CyI_OqvZ.js";import{D as z}from"./DContext-BAc4NIae.js";import"./iframe-uHxPMequ.js";import"./preload-helper-Dp1pzeXC.js";import"./index-4TPiY_w5.js";import"./DIcon-DzHhTXeq.js";import"./useMediaBreakpointUp-DLsS5ULk.js";import"./index-DboxJWp3.js";import"./index-Drp_xGtg.js";const G={title:"Design System/Components/Button Icon",component:S,parameters:{docs:{description:{component:`
...
| --${t}btn-sm-border-radius   | :root | css length unit | Button small border radius      |
        `}}},argTypes:{className:{control:"text",type:"string"},style:{control:"object"},id:{control:"text",type:"string"},ariaLabel:{control:"text",type:"string"},href:{control:"text",description:"If provided, renders as an &lt;a&gt; element instead of &lt;button&gt;."},target:{control:"select",options:[void 0,"_self","_blank","_parent","_top"],description:"Anchor target when href is set."},rel:{control:"text",description:'Anchor rel attribute (use "noopener noreferrer" with target="_blank").'},color:{control:"select",options:I,table:{defaultValue:{summary:"primary"}}},size:{control:{type:"select"},type:"string",options:_},type:{control:"select",type:"string",options:["submit","reset","button"],table:{defaultValue:{summary:"button"}},description:"The html type of the button."},icon:{control:{type:"select",table:{defaultValue:{summary:"arrow-left"}}},options:[void 0,...C]},iconFamilyClass:{control:"text",type:"string"},iconFamilyPrefix:{control:"text",type:"string"},iconMaterialStyle:{control:"boolean",type:"boolean"},loading:{control:"boolean",table:{defaultValue:{summary:"false"}},type:"boolean"},disabled:{control:"boolean",table:{defaultValue:{summary:"false"}},type:"boolean"},loadingAriaLabel:{control:"text",type:"string"},state:{control:{type:"select",labels:{undefined:"empty"}},options:[void 0,...A],type:"string",description:"Change the state of the button"},stopPropagationEnabled:{control:"boolean",table:{defaultValue:{summary:"true"}},type:"boolean"},onClick:{action:"onClick"},variant:{control:"select",options:[void 0,"outline","link"]}},tags:["autodocs"]},e={args:{color:"primary",size:void 0,type:"button",variant:void 0,loading:!1,icon:"ArrowLeft"}},n={args:{color:"secondary",size:void 0,type:"button",variant:"outline",loading:!1,icon:"ArrowLeft"}},r={args:{color:"secondary",size:void 0,type:"button",variant:"link",loading:!1,icon:"ArrowLeft"}},a={args:{color:"primary",icon:"ArrowRight",href:"https://dynamicframework.dev",target:"_blank",rel:"noopener noreferrer"}},o={render:$=>s.jsx(z,{...T,children:s.jsx(S,{...$})}),args:{color:"primary",size:void 0,type:"button",loading:!1,icon:"arrow_back"},parameters:{docs:{canvas:{sourceState:"shown"}}}};var i,l,c;e.parameters={...e.parameters,docs:{...(i=e.parameters)==null?void 0:i.docs,source:{originalSource:`{
  args: {
    color: 'primary',
    size: undefined,
    type: 'button',
...
}`,...(c=(l=e.parameters)==null?void 0:l.docs)==null?void 0:c.source}}};var d,u,b;n.parameters={...n.parameters,docs:{...(d=n.parameters)==null?void 0:d.docs,source:{originalSource:`{
  args: {
    color: 'secondary',
    size: undefined,
    type: 'button',
...
}`,...(b=(u=n.parameters)==null?void 0:u.docs)==null?void 0:b.source}}};var p,g,h;r.parameters={...r.parameters,docs:{...(p=r.parameters)==null?void 0:p.docs,source:{originalSource:`{
  args: {
    color: 'secondary',
    size: undefined,
    type: 'button',
...
}`,...(h=(g=r.parameters)==null?void 0:g.docs)==null?void 0:h.source}}};var m,f,y;a.parameters={...a.parameters,docs:{...(m=a.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
    color: 'primary',
    icon: 'ArrowRight',
...
}`,...(y=(f=a.parameters)==null?void 0:f.docs)==null?void 0:y.source}}};var v,x,w,k,B;o.parameters={...o.parameters,docs:{...(v=o.parameters)==null?void 0:v.docs,source:{originalSource:`{
...
}`,...(w=(x=o.parameters)==null?void 0:x.docs)==null?void 0:w.source},description:{story:"To use buttons with Material Symbols style use a `DContextProvider` with `familyClass`\nand the flag `materialStyle=true` or use the flags directly over the\n`DButtonIcon` component as a props",...(B=(k=o.parameters)==null?void 0:k.docs)==null?void 0:B.description}}};const H=["Primary","Secondary","Link","AsAnchor","MaterialSecondaryIconRight"];export{a as AsAnchor,r as Link,o as MaterialSecondaryIconRight,e as Primary,n as Secondary,H as __namedExportsOrder,G as default};
