import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as d}from"./iframe-Yvsh7xC9.js";import{c as g}from"./index-DvQjpGce.js";import{u as M,a as z,b as U,c as X,d as J,e as G,F as H}from"./floating-ui.react-BhERQW09.js";import{P as K}from"./config-C3iYXcFk.js";import{b as L}from"./floating-ui.dom-osFzHgfv.js";import{o as Q,f as W,s as Y}from"./floating-ui.react-dom-B0JxQWhJ.js";import{D as Z}from"./DButton-TGnXMkmd.js";import{D as p}from"./DCard-BqO0OYLn.js";function n({children:o,renderComponent:m,open:u,setOpen:c,adjustContentToRender:l=!1,className:E,style:f,dataAttributes:N}){const[i,C]=d.useState(!1);d.useEffect(()=>{C(u)},[u]);const k=d.useCallback(D=>{C(D),c&&c(D)},[c]),{refs:v,floatingStyles:F,context:s}=M({open:i,onOpenChange:k,middleware:[Q(0),W({fallbackAxisSideDirection:"none"}),Y()],whileElementsMounted:L}),T=z(s),V=U(s),q=X(s),{getReferenceProps:A,getFloatingProps:I}=J([T,V,q]),O=G(),$=d.useMemo(()=>({...f,...l&&{[`--${K}popover-component-min-width`]:"auto"}}),[f,l]);return e.jsxs("div",{className:g("d-popover",E),style:$,...N,children:[e.jsx("div",{ref:v.setReference,...A(),children:m(i)}),i&&e.jsx(H,{context:s,modal:!1,children:e.jsx("div",{className:g("d-popover-content",{"w-100":l}),ref:v.setFloating,style:F,"aria-labelledby":O,...I(),children:o})})]})}try{n.displayName="DPopover",n.__docgenInfo={description:"",displayName:"DPopover",props:{style:{defaultValue:null,description:"",name:"style",required:!1,type:{name:"CSSProperties | undefined"}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string | undefined"}},dataAttributes:{defaultValue:null,description:"",name:"dataAttributes",required:!1,type:{name:"DataAttributes | undefined"}},renderComponent:{defaultValue:null,description:`Component to render in call to action
@param open
