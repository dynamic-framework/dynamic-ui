import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{P as r}from"./config-C3iYXcFk.js";import{c as S}from"./index-DgkJcE1x.js";import"./iframe-DyLtBo21.js";import"./preload-helper-Dp1pzeXC.js";const I="https://cdn.modyo.cloud/uploads/06b434f7-b943-4f54-9543-84a904e189aa/original/Visa_Logo_1_.png",z="https://cdn.modyo.cloud/uploads/4660ad00-e5d8-477e-8919-52b53d0a26fb/original/chip-debit-svgrepo-com_1_.png";function t({brand:a="visa",name:x,number:V,holderText:D="Card Holder",logoImage:j,isChipVisible:w=!0,className:_,isVertical:N=!1}){return e.jsxs("div",{className:S("d-credit-card overflow-hidden text-white","position-relative rounded-3","d-flex",N&&"is-vertical",_),children:[e.jsxs("div",{className:"d-credit-card-header",children:[e.jsx("img",{src:j||I,alt:a,className:"d-credit-card-logo",width:100}),w&&e.jsx("div",{className:"d-credit-card-chip p-2 rounded-2",children:e.jsx("img",{src:z,alt:"chip",width:30,className:"d-credit-card-chip-image"})})]}),e.jsxs("div",{className:"d-credit-card-details mt-auto d-none d-sm-block",children:[e.jsx("div",{className:"d-credit-card-number d-none d-sm-block mb-4",children:V}),e.jsx("small",{className:"d-block opacity-50",children:D}),e.jsx("span",{className:"name",children:x})]})]})}try{t.displayName="DCreditCard",t.__docgenInfo={description:"",displayName:"DCreditCard",props:{className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string | undefined"}},brand:{defaultValue:{value:"visa"},description:"",name:"brand",required:!1,type:{name:"string | undefined"}},isChipVisible:{defaultValue:{value:"true"},description:"",name:"isChipVisible",required:!1,type:{name:"boolean | undefined"}},name:{defaultValue:null,description:"",name:"name",required:!1,type:{name:"string | undefined"}},number:{defaultValue:null,description:"",name:"number",required:!1,type:{name:"string | undefined"}},holderText:{defaultValue:{value:"Card Holder"},description:"",name:"holderText",required:!1,type:{name:"string | undefined"}},isVertical:{defaultValue:{value:"false"},description:"",name:"isVertical",required:!1,type:{name:"boolean | undefined"}},logoImage:{defaultValue:null,description:"",name:"logoImage",required:!1,type:{name:"string | undefined"}}}}}catch{}const E={title:"Design System/Components/Credit Card",component:t,parameters:{docs:{description:{component:`
...
}`,...(p=(l=d.parameters)==null?void 0:l.docs)==null?void 0:p.source}}};var m,u,h;i.parameters={...i.parameters,docs:{...(m=i.parameters)==null?void 0:m.docs,source:{originalSource:`{
  render: args => <div style={{
    width: 300
  }}>
      <DCreditCard {...args} />
...
}`,...(h=(u=i.parameters)==null?void 0:u.docs)==null?void 0:h.source}}};var g,f,y;s.parameters={...s.parameters,docs:{...(g=s.parameters)==null?void 0:g.docs,source:{originalSource:`{
  render: args => <div style={{
    width: 200
  }}>
      <DCreditCard {...args} />
...
}`,...(v=(C=n.parameters)==null?void 0:C.docs)==null?void 0:v.source}}};const k=["Default","WithoutChip","VerticalLayout","CustomLogo"];export{n as CustomLogo,d as Default,s as VerticalLayout,i as WithoutChip,k as __namedExportsOrder,E as default};
