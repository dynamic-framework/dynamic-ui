import{j as a}from"./jsx-runtime-D_zvdyIk.js";import{D as x}from"./DButtonIcon-DoK5rkAY.js";import{P as t}from"./config-C3iYXcFk.js";import{b as k,I as B,c as $,T as S,a as C}from"./constants-BoPmzNgw.js";import{D as T}from"./DContext-DnrHYxse.js";import"./iframe-Yvsh7xC9.js";import"./index-DvQjpGce.js";import"./DIcon-kG3_WTRG.js";import"./index-B907fQrS.js";import"./index-BVHJzkj7.js";const R={title:"Design System/Components/Button Icon",component:x,parameters:{docs:{description:{component:`
...
| --${t}btn-sm-border-radius   | :root | css length unit | Button small border radius      |
        `}}},argTypes:{className:{control:"text",type:"string"},style:{control:"object"},id:{control:"text",type:"string"},ariaLabel:{control:"text",type:"string"},color:{control:"select",type:{name:"string",required:!0},options:S,table:{defaultValue:{summary:"primary"}}},size:{control:{type:"select",labels:{undefined:"default"}},type:"string",options:$},type:{control:"select",type:"string",options:["submit","reset","button"],table:{defaultValue:{summary:"button"}},description:"The html type of the button."},icon:{control:{type:"select",table:{defaultValue:{summary:"arrow-left"}}},options:[void 0,...B]},iconFamilyClass:{control:"text",type:"string"},iconFamilyPrefix:{control:"text",type:"string"},iconMaterialStyle:{control:"boolean",type:"boolean"},loading:{control:"boolean",table:{defaultValue:{summary:"false"}},type:"boolean"},disabled:{control:"boolean",table:{defaultValue:{summary:"false"}},type:"boolean"},loadingAriaLabel:{control:"text",type:"string"},state:{control:{type:"select",labels:{undefined:"empty"}},options:[void 0,...k],type:"string",description:"Change the state of the button"},stopPropagationEnabled:{control:"boolean",table:{defaultValue:{summary:"true"}},type:"boolean"},onClick:{action:"onClick"}},tags:["autodocs"]},e={args:{color:"primary",size:void 0,type:"button",variant:void 0,loading:!1,icon:"ArrowLeft"}},n={args:{color:"secondary",size:void 0,type:"button",variant:"outline",loading:!1,icon:"ArrowLeft"}},r={args:{color:"secondary",size:void 0,type:"button",variant:"link",loading:!1,icon:"ArrowLeft"}},o={render:w=>a.jsx(T,{...C,children:a.jsx(x,{...w})}),args:{color:"primary",size:void 0,type:"button",loading:!1,icon:"arrow_back"},parameters:{docs:{canvas:{sourceState:"shown"}}}};var s,i,l;e.parameters={...e.parameters,docs:{...(s=e.parameters)==null?void 0:s.docs,source:{originalSource:`{
  args: {
    color: 'primary',
    size: undefined,
    type: 'button',
...
}`,...(f=(m=o.parameters)==null?void 0:m.docs)==null?void 0:f.source},description:{story:"To use buttons with Material Symbols style use a `DContextProvider` with `familyClass`\nand the flag `materialStyle=true` or use the flags directly over the\n`DButtonIcon` component as a props",...(v=(y=o.parameters)==null?void 0:y.docs)==null?void 0:v.description}}};const N=["Primary","Secondary","Link","MaterialSecondaryIconRight"];export{r as Link,o as MaterialSecondaryIconRight,e as Primary,n as Secondary,N as __namedExportsOrder,R as default};
