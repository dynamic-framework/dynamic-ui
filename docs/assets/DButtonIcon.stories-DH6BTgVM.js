...
| --${e}btn-sm-border-radius   | :root | css length unit | Button small border radius      |
        `}}},argTypes:{className:{control:"text",type:"string"},style:{control:"object"},id:{control:"text",type:"string"},ariaLabel:{control:"text",type:"string"},theme:{control:"select",type:{name:"string",required:!0},options:W,table:{defaultValue:{summary:"primary"}}},size:{control:{type:"select",labels:{undefined:"default"}},type:"string",options:Z},type:{control:"select",type:"string",options:["submit","reset","button"],table:{defaultValue:{summary:"button"}},description:"The html type of the button."},icon:{control:{type:"select",table:{defaultValue:{summary:"arrow-left"}}},options:[void 0,...J]},iconFamilyClass:{control:"text",type:"string"},iconFamilyPrefix:{control:"text",type:"string"},iconMaterialStyle:{control:"boolean",type:"boolean"},loading:{control:"boolean",table:{defaultValue:{summary:"false"}},type:"boolean"},disabled:{control:"boolean",table:{defaultValue:{summary:"false"}},type:"boolean"},loadingAriaLabel:{control:"text",type:"string"},state:{control:{type:"select",labels:{undefined:"empty"}},options:[void 0,...K],type:"string",description:"Change the state of the button"},stopPropagationEnabled:{control:"boolean",table:{defaultValue:{summary:"true"}},type:"boolean"},onClick:{action:"onClick"}},tags:["autodocs"]},l={args:{theme:"primary",size:void 0,type:"button",variant:void 0,loading:!1,icon:"arrow-left"}},d={args:{theme:"secondary",size:void 0,type:"button",variant:"outline",loading:!1,icon:"arrow-left"}},u={args:{theme:"secondary",size:void 0,type:"button",variant:"link",loading:!1,icon:"arrow-left"}},a={render:r=>o.jsx(Y,{...Q,children:o.jsx(c,{...r})}),args:{theme:"primary",size:void 0,type:"button",loading:!1,icon:"arrow_back"},parameters:{docs:{canvas:{sourceState:"shown"}}}};var x,w,k;l.parameters={...l.parameters,docs:{...(x=l.parameters)==null?void 0:x.docs,source:{originalSource:`{
  args: {
    theme: 'primary',
    size: undefined,
    type: 'button',
