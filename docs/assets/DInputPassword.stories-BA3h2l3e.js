...
| --${e}form-control-text-align     | .form-control | css text align  | Input text align            |
        `}}},argTypes:{id:{control:"text",type:"string",description:"The id of the input"},name:{control:"text",type:"string",description:"The name of the input"},className:{control:"text",type:"string"},style:{control:"object"},label:{control:"text",type:"string"},labelIcon:{control:{type:"select",labels:{undefined:"empty"}},type:"string",options:[void 0,...H]},placeholder:{control:"text",type:"string"},value:{control:"text",type:"string",description:"The value of the input"},size:{control:{type:"radio",labels:{undefined:"empty"}},type:"string",options:[void 0,"sm","lg"]},disabled:{control:"boolean",type:"boolean",table:{defaultValue:{summary:"false"}}},readOnly:{control:"boolean",type:"boolean",table:{defaultValue:{summary:"false"}}},loading:{control:"boolean",type:"boolean",table:{defaultValue:{summary:"false"}}},hint:{control:"text",type:"string",description:"Hint to display, also used to display validity feedback"},iconEndAriaLabel:{control:"text",type:"string"},invalid:{control:"boolean",type:"boolean",table:{defaultValue:{summary:"false"}}},valid:{control:"boolean",type:"boolean",table:{defaultValue:{summary:"false"}}},floatingLabel:{control:"boolean",type:"boolean",table:{defaultValue:{summary:"false"}}},onChange:{action:"onChange"}},tags:["autodocs"]},l={args:{id:"componentId1",label:"Label",placeholder:"Placeholder",labelIcon:void 0,value:void 0,iconEndAriaLabel:"show/hide password"}},o={args:{id:"componentId3",label:"Label",placeholder:"Placeholder",labelIcon:void 0,value:void 0,invalid:!0,iconEndAriaLabel:"show/hide password"}},t={args:{id:"componentId4",label:"Label",placeholder:"Placeholder",labelIcon:void 0,value:void 0,valid:!0,iconEndAriaLabel:"show/hide password"}},i={args:{id:"componentId5",label:"Label",placeholder:"Placeholder",labelIcon:void 0,value:void 0,disabled:!0,iconEndAriaLabel:"show/hide password"}},r={args:{id:"componentId6",label:"Label",placeholder:"Placeholder",labelIcon:void 0,value:void 0,iconEndAriaLabel:"show/hide password",floatingLabel:!0}},d={render:n=>c.jsx(G,{...X,children:c.jsx(m,{...n})}),args:{id:"componentId7",label:"Label",placeholder:"Placeholder",labelIcon:void 0,value:void 0,iconEndAriaLabel:"show/hide password"},parameters:{docs:{canvas:{sourceState:"shown"}}}};var f,b,g;l.parameters={...l.parameters,docs:{...(f=l.parameters)==null?void 0:f.docs,source:{originalSource:`{
  args: {
    id: 'componentId1',
    label: 'Label',
...
}`,...(g=(b=l.parameters)==null?void 0:b.docs)==null?void 0:g.source}}};var y,h,I;o.parameters={...o.parameters,docs:{...(y=o.parameters)==null?void 0:y.docs,source:{originalSource:`{
  args: {
    id: 'componentId3',
    label: 'Label',
    placeholder: 'Placeholder',
...
}`,...(I=(h=o.parameters)==null?void 0:h.docs)==null?void 0:I.source}}};var v,w,V;t.parameters={...t.parameters,docs:{...(v=t.parameters)==null?void 0:v.docs,source:{originalSource:`{
  args: {
    id: 'componentId4',
    label: 'Label',
    placeholder: 'Placeholder',
...
}`,...(V=(w=t.parameters)==null?void 0:w.docs)==null?void 0:V.source}}};var S,x,L;i.parameters={...i.parameters,docs:{...(S=i.parameters)==null?void 0:S.docs,source:{originalSource:`{
  args: {
    id: 'componentId5',
    label: 'Label',
    placeholder: 'Placeholder',
...
}`,...(L=(x=i.parameters)==null?void 0:x.docs)==null?void 0:L.source}}};var E,P,q;r.parameters={...r.parameters,docs:{...(E=r.parameters)==null?void 0:E.docs,source:{originalSource:`{
  args: {
    id: 'componentId6',
    label: 'Label',
    placeholder: 'Placeholder',
...
}`,...(q=(P=r.parameters)==null?void 0:P.docs)==null?void 0:q.source}}};var C,D,F;d.parameters={...d.parameters,docs:{...(C=d.parameters)==null?void 0:C.docs,source:{originalSource:`{
...
}`,...(F=(D=d.parameters)==null?void 0:D.docs)==null?void 0:F.source}}};const oe=["Default","Invalid","Valid","Disabled","Floating","MaterialIcon"];export{l as Default,i as Disabled,r as Floating,o as Invalid,d as MaterialIcon,t as Valid,oe as __namedExportsOrder,le as default};
