import{j as e}from"./jsx-runtime-CKrituN3.js";import{P as n}from"./config-CUZHf55T.js";import{r as s}from"./index-CBqU2yxZ.js";import{c as A}from"./index-ELyB7pIJ.js";import"./_commonjsHelpers-BosuxZz1.js";function i({id:t,name:c,value:b,line1:v,line2:N,className:C,style:D,selected:u=!1,dataAttributes:V,onChange:o}){const d=s.useRef(null),m=s.useId(),p=s.useMemo(()=>t||m,[t,m]),w=s.useCallback(g=>{g.stopPropagation(),o==null||o(g)},[o]);return s.useEffect(()=>{d.current&&(d.current.checked=u)},[u]),e.jsxs("label",{className:A("d-quick-action-select",C),htmlFor:p,style:D,...V,children:[e.jsx("input",{ref:d,id:p,type:"radio",name:c,value:b,onChange:w}),e.jsx("span",{className:"d-quick-action-select-line1",children:v}),e.jsx("span",{className:"d-quick-action-select-line2",children:N})]})}try{i.displayName="DQuickActionSelect",i.__docgenInfo={description:"",displayName:"DQuickActionSelect",props:{style:{defaultValue:null,description:"",name:"style",required:!1,type:{name:"CSSProperties | undefined"}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string | undefined"}},dataAttributes:{defaultValue:null,description:"",name:"dataAttributes",required:!1,type:{name:"DataAttributes | undefined"}},id:{defaultValue:null,description:"",name:"id",required:!1,type:{name:"string | undefined"}},name:{defaultValue:null,description:"",name:"name",required:!0,type:{name:"string"}},value:{defaultValue:null,description:"",name:"value",required:!0,type:{name:"string"}},line1:{defaultValue:null,description:"",name:"line1",required:!0,type:{name:"string"}},line2:{defaultValue:null,description:"",name:"line2",required:!0,type:{name:"string"}},selected:{defaultValue:{value:"false"},description:"",name:"selected",required:!1,type:{name:"boolean | undefined"}},onChange:{defaultValue:null,description:"",name:"onChange",required:!1,type:{name:"((event: ChangeEvent<HTMLInputElement>) => void) | undefined"}}}}}catch{}const T={title:"Design System/Components/Quick Action Select",component:i,parameters:{docs:{description:{component:`
## CSS Variables
...
}`,...(j=($=r.parameters)==null?void 0:$.docs)==null?void 0:j.source}}};const z=["Default","Example","Selected"];export{a as Default,l as Example,r as Selected,z as __namedExportsOrder,T as default};
