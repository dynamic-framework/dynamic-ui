import{j as s}from"./jsx-runtime-D_zvdyIk.js";import{r as d}from"./iframe-B_y6UB7Z.js";import{F as _e}from"./DInputPassword-BKWaXaVR.js";import{c as T}from"./index-DjkKVd-P.js";import{D as Ae}from"./DIcon-CvCEcTnV.js";import"./DInput-CIaXhe2I.js";import"./useProvidedRefOrCreate-DERnvhoR.js";import"./DContext-poyny3cD.js";import"./index-uACc-hGT.js";import"./index-Bmp1N_eR.js";import"./config-C3iYXcFk.js";function A({password:r,regex:a,text:e}){const t=a.test(r);return s.jsxs("li",{className:"d-flex gap-2 align-items-start small text-gray-600",children:[s.jsx(Ae,{className:T("flex-shrink-0",t?"text-success":"text-gray-300"),icon:t?"CircleCheck":"Circle",size:"16px"}),s.jsx("span",{className:T({"text-success":t}),children:e})]})}try{A.displayName="PasswordCheckItem",A.__docgenInfo={description:"",displayName:"PasswordCheckItem",props:{password:{defaultValue:null,description:"",name:"password",required:!0,type:{name:"string"}},regex:{defaultValue:null,description:"",name:"regex",required:!0,type:{name:"RegExp"}},text:{defaultValue:null,description:"",name:"text",required:!0,type:{name:"string"}}}}}catch{}const Me=(r,a)=>{const e=a>0?r/a:0;return e===0?"bg-gray-200":e<=.25?"bg-danger":e<=.5?"bg-warning":e<=.75?"bg-info":"bg-success"};function Ne({strength:r,total:a}){const e=a>0?r/a*100:0;return s.jsx("div",{className:"w-100 rounded-3 overflow-hidden bg-gray-100 mb-2",style:{height:"8px"},children:s.jsx("div",{className:`h-100 ${Me(r,a)}`,style:{width:`${e}%`,transition:"width 0.3s ease-in-out"}})})}try{PasswordStrength.displayName="PasswordStrength",PasswordStrength.__docgenInfo={description:"",displayName:"PasswordStrength",props:{strength:{defaultValue:null,description:"",name:"strength",required:!0,type:{name:"number"}},total:{defaultValue:null,description:"",name:"total",required:!0,type:{name:"number"}}}}}catch{}const i={uppercase:/[A-Z]/,lowercase:/[a-z]/,number:/\d/,specialChar:/[~!@#$^*\-_=[\]{}|;,.?]/};function Le({password:r,validationMessages:a,enabledChecks:e}){const n=[{key:"uppercase",regex:i.uppercase,text:a.uppercaseLetter},{key:"lowercase",regex:i.lowercase,text:a.lowercaseLetter},{key:"number",regex:i.number,text:a.number},{key:"specialChar",regex:i.specialChar,text:a.especialChar}].filter(o=>e.includes(o.key)),P=n.filter(o=>o.regex.test(r)).length,S=n.length;return s.jsxs("div",{className:"mt-2",children:[s.jsx(Ne,{strength:P,total:S}),s.jsx("ul",{className:"list-unstyled m-0 d-flex flex-column gap-2",children:n.map(({key:o,regex:q,text:V})=>s.jsx(A,{password:r,regex:q,text:V},o))})]})}try{PasswordCheckList.displayName="PasswordCheckList",PasswordCheckList.__docgenInfo={description:"",displayName:"PasswordCheckList",props:{password:{defaultValue:null,description:"",name:"password",required:!0,type:{name:"string"}},validationMessages:{defaultValue:null,description:"",name:"validationMessages",required:!0,type:{name:"ValidationMessages"}},enabledChecks:{defaultValue:null,description:"",name:"enabledChecks",required:!0,type:{name:"ValidationCheck[]"}}}}}catch{}const Te={number:"At least one number",lowercaseLetter:"At least one lowercase letter",uppercaseLetter:"At least one uppercase letter",especialChar:"At least one of these special characters: ~!@#$^*-_=[]{}|;,.?",notMatch:"The password confirmation and the new password do not match."},je=["uppercase","lowercase","number","specialChar"];function l({id:r,label:a="Password",placeholder:e,value:t="",name:n,disabled:P=!1,readonly:S=!1,invalid:o=!1,validFeedback:q,invalidFeedback:V,validationMessages:ke=Te,enabledChecks:xe=je,className:Pe,style:Se,dataAttributes:qe,onChange:_}){const[M,N]=d.useState(t);d.useEffect(()=>{N(t)},[t]);const Ve=L=>{N(L),_==null||_(L)};return s.jsxs("div",{className:Pe,style:Se,...qe,children:[s.jsx(_e,{id:r,label:a,placeholder:e,value:M,name:n,disabled:P,readonly:S,invalid:o,validFeedback:q,invalidFeedback:V,onChange:Ve}),s.jsx(Le,{password:M,validationMessages:ke,enabledChecks:xe})]})}try{l.displayName="DPasswordStrengthMeter",l.__docgenInfo={description:"",displayName:"DPasswordStrengthMeter",props:{style:{defaultValue:null,description:"",name:"style",required:!1,type:{name:"CSSProperties | undefined"}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string | undefined"}},dataAttributes:{defaultValue:null,description:"",name:"dataAttributes",required:!1,type:{name:"DataAttributes | undefined"}},id:{defaultValue:null,description:"",name:"id",required:!1,type:{name:"string | undefined"}},label:{defaultValue:{value:"Password"},description:"",name:"label",required:!1,type:{name:"string | undefined"}},placeholder:{defaultValue:null,description:"",name:"placeholder",required:!1,type:{name:"string | undefined"}},value:{defaultValue:{value:""},description:"",name:"value",required:!1,type:{name:"string | undefined"}},name:{defaultValue:null,description:"",name:"name",required:!1,type:{name:"string | undefined"}},disabled:{defaultValue:{value:"false"},description:"",name:"disabled",required:!1,type:{name:"boolean | undefined"}},readonly:{defaultValue:{value:"false"},description:"",name:"readonly",required:!1,type:{name:"boolean | undefined"}},invalid:{defaultValue:{value:"false"},description:"",name:"invalid",required:!1,type:{name:"boolean | undefined"}},validFeedback:{defaultValue:null,description:"",name:"validFeedback",required:!1,type:{name:"string | undefined"}},invalidFeedback:{defaultValue:null,description:"",name:"invalidFeedback",required:!1,type:{name:"string | undefined"}},validationMessages:{defaultValue:{value:`{
...
\`\`\`
  ...
  render: function WithFeedbackRender(args) {
    ...
    return <DPasswordStrengthMeter {...args} value={password} onChange={setPassword} invalid={password.length > 0 && !isValid} invalidFeedback={password.length > 0 && !isValid ? 'Password must meet all requirements' : undefined} validFeedback={isValid ? 'Strong password!' : undefined} />;
  },
  args: {
    id: 'password8',
...
}`,...(oe=(ne=f.parameters)==null?void 0:ne.docs)==null?void 0:oe.source}}};var le,de,ie;y.parameters={...y.parameters,docs:{...(le=y.parameters)==null?void 0:le.docs,source:{originalSource:`{
...
}`,...(ie=(de=y.parameters)==null?void 0:de.docs)==null?void 0:ie.source}}};var ce,ue,pe;C.parameters={...C.parameters,docs:{...(ce=C.parameters)==null?void 0:ce.docs,source:{originalSource:`{
  args: {
    id: 'password11',
...
}`,...(pe=(ue=C.parameters)==null?void 0:ue.docs)==null?void 0:pe.source}}};var me,he,ge;v.parameters={...v.parameters,docs:{...(me=v.parameters)==null?void 0:me.docs,source:{originalSource:`{
  args: {
    id: 'password12',
...
}`,...(fe=(be=k.parameters)==null?void 0:be.docs)==null?void 0:fe.source}}};var ye,Ce,ve;x.parameters={...x.parameters,docs:{...(ye=x.parameters)==null?void 0:ye.docs,source:{originalSource:`{
