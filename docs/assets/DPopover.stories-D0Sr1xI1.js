import{j as e}from"./jsx-runtime-CKrituN3.js";import{r as c}from"./index-CBqU2yxZ.js";import{c as j}from"./index-ELyB7pIJ.js";import{u as X,a as z,b as J,c as U,d as G,e as H,F as K}from"./floating-ui.react-DVVP0NTz.js";import{P as W}from"./config-CUZHf55T.js";import{o as Y,f as Z,s as ee,a as oe}from"./floating-ui.dom-Hl2SHHju.js";import{D as t}from"./DQuickActionButton-DbV18lUY.js";import{D as u}from"./DButton-DMz62NRO.js";function n({children:o,renderComponent:B,open:g,setOpen:d,adjustContentToRender:p=!1,className:_,style:f,dataAttributes:k}){const[m,x]=c.useState(!1);c.useEffect(()=>{x(g)},[g]);const R=c.useCallback(v=>{x(v),d&&d(v)},[d]),{refs:h,floatingStyles:Q,context:l}=X({open:m,onOpenChange:R,middleware:[Y(0),Z({fallbackAxisSideDirection:"none"}),ee()],whileElementsMounted:oe}),T=z(l),O=J(l),V=U(l),{getReferenceProps:q,getFloatingProps:F}=G([T,O,V]),$=H(),M=c.useMemo(()=>({...f,...p&&{[`--${W}popover-component-min-width`]:"auto"}}),[f,p]);return e.jsxs("div",{className:j("d-popover",_),style:M,...k,children:[e.jsx("div",{ref:h.setReference,...q(),children:B(m)}),m&&e.jsx(K,{context:l,modal:!1,children:e.jsx("div",{className:j("d-popover-content",{"w-100":p}),ref:h.setFloating,style:Q,"aria-labelledby":$,...F(),children:o})})]})}try{n.displayName="DPopover",n.__docgenInfo={description:"",displayName:"DPopover",props:{style:{defaultValue:null,description:"",name:"style",required:!1,type:{name:"CSSProperties | undefined"}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string | undefined"}},dataAttributes:{defaultValue:null,description:"",name:"dataAttributes",required:!1,type:{name:"DataAttributes | undefined"}},renderComponent:{defaultValue:null,description:`Component to render in call to action
@param open
