...
}`,...(h=(b=r.parameters)==null?void 0:b.docs)==null?void 0:h.source},description:{story:"To use Stepper with Material Symbols style use a `DContextProvider` with `familyClass`\nand the flag `materialStyle=true` or use the flags directly over the\n`DStepper` component as a props",...(D=(x=r.parameters)==null?void 0:x.docs)==null?void 0:D.description}}};const K=["Default","DefaultMobile","Vertical","MaterialStyle"];export{i as Default,o as DefaultMobile,r as MaterialStyle,a as Vertical,K as __namedExportsOrder,J as default};
