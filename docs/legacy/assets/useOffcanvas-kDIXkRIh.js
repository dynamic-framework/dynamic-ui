...
export function ExampleOffcanvasUsage() {
  ...
  return (
    ...
    `,language:"tsx",dark:!0}),`
`,e.jsx(i,{children:e.jsx("div",{className:"d-flex flex-column justify-content-end align-items-end",children:e.jsx(x,{})})})]})}function U(o={}){const{wrapper:a}={...c(),...o.components};return a?e.jsx(a,{...o,children:e.jsx(r,{...o})}):r(o)}export{U as default};
