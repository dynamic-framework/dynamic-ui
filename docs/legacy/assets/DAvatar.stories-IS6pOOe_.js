import{j as e}from"./jsx-runtime-DztICxWZ.js";import{r as A}from"./index-Bv9Y92EF.js";import{c as L}from"./index-PkosZWDx.js";import{C as O,A as G}from"./constants-DV08vUJ9.js";import{P as r}from"./config-BV4l-vIF.js";import"./_commonjsHelpers-Cpj98o6Y.js";function s({id:a,size:c,image:m,name:t,useNameAsInitials:f=!1,theme:p="secondary",variant:g,className:M,style:R,dataAttributes:k}){const J=A.useMemo(()=>({"d-avatar":!0,[g?`d-avatar-${g}-${p}`:`d-avatar-${p}`]:!0,[`d-avatar-${c}`]:!!c}),[g,p,c]),v=A.useMemo(()=>{if(t)return f?t:t.split(/\s+/).map(y=>y.charAt(0)).join("").toUpperCase()},[t,f]);return e.jsxs("div",{className:L(J,M),style:R,id:a,...k,children:[m&&e.jsx("img",{src:m,alt:t,className:"d-avatar-img"}),v&&!m&&e.jsx("span",{className:"d-avatar-name",children:v})]})}try{s.displayName="DAvatar",s.__docgenInfo={description:"",displayName:"DAvatar",props:{style:{defaultValue:null,description:"",name:"style",required:!1,type:{name:"CSSProperties | undefined"}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string | undefined"}},dataAttributes:{defaultValue:null,description:"",name:"dataAttributes",required:!1,type:{name:"DataAttributes | undefined"}},id:{defaultValue:null,description:"",name:"id",required:!1,type:{name:"string | undefined"}},size:{defaultValue:null,description:"",name:"size",required:!1,type:{name:"enum",value:[{value:"undefined"},{value:'"sm"'},{value:'"lg"'},{value:'"xl"'},{value:'"xxl"'},{value:'"xs"'}]}},image:{defaultValue:null,description:"",name:"image",required:!1,type:{name:"string | undefined"}},name:{defaultValue:null,description:"",name:"name",required:!1,type:{name:"string | undefined"}},useNameAsInitials:{defaultValue:{value:"false"},description:"",name:"useNameAsInitials",required:!1,type:{name:"boolean | undefined"}},theme:{defaultValue:{value:"secondary"},description:"",name:"theme",required:!1,type:{name:"string | undefined"}},variant:{defaultValue:null,description:"",name:"variant",required:!1,type:{name:"enum",value:[{value:"undefined"},{value:'"dark"'},{value:'"light"'}]}}}}}catch{}const P={title:"Design System/Components/Avatar",component:s,parameters:{docs:{description:{component:`
## CSS Variables
