...
}`,...(q=(_=a.parameters)==null?void 0:_.docs)==null?void 0:q.source},description:{story:"To use buttons with Material Symbols style use a `DContextProvider` with `familyClass`\nand the flag `materialStyle=true` or use the flags directly over the\n`DButtonIcon` component as a props",...(E=(D=a.parameters)==null?void 0:D.docs)==null?void 0:E.description}}};const ce=["Primary","Secondary","Link","MaterialSecondaryIconRight"];export{u as Link,a as MaterialSecondaryIconRight,l as Primary,d as Secondary,ce as __namedExportsOrder,ue as default};
