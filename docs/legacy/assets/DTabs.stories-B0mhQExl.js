import{j as a}from"./jsx-runtime-DztICxWZ.js";import{D as t}from"./DTabs-BIRoQuSz.js";import{P as i}from"./config-BV4l-vIF.js";import{e as D}from"./constants-DV08vUJ9.js";import"./index-Bv9Y92EF.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-PkosZWDx.js";const L={title:"Design System/Patterns/Tabs",component:t,parameters:{docs:{description:{component:`
...
| --${i}nav-tabs-border-color                   | .nav-pills, .nav-underline, .nav-tabs | css color       | Nav border color                   |
| --${i}nav-link-padding-x                      | .nav-pills, .nav-underline, .nav-tabs | css length unit | Nav link padding horizontal        |
| --${i}nav-link-padding-y                      | .nav-pills, .nav-underline, .nav-tabs | css length unit | Nav link padding vertical          |
| --${i}nav-link-hover-bg                       | .nav-pills, .nav-underline, .nav-tabs | css color       | Nav link hover background          |
| --${i}nav-link-hover-color                    | .nav-pills, .nav-underline, .nav-tabs | css color       | Nav link hover color               |
        `}}},argTypes:{className:{control:"text",type:"string"},style:{control:"object"},vertical:{type:"boolean",control:"boolean",table:{defaultValue:{summary:"false"}}},variant:{type:"string",options:D,control:"select",table:{defaultValue:{summary:"underline"}}}},tags:["autodocs"]},s={decorators:[e=>a.jsx("div",{style:{width:"576px",height:"220px"},className:"d-flex justify-content-center gap-3",children:a.jsx(e,{})})],render:e=>a.jsxs(t,{...e,children:[a.jsx(t.Tab,{tab:"tab1",children:"Tab content for Tab 1. Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eligendi error beatae temporibus cupiditate quasi ut enim vero, consectetur mollitia soluta! Officiis maxime laboriosam, beatae quia earum id velit, doloribus, voluptatibus soluta ea molestiae? Quo molestiae rem iusto atque beatae aliquam."}),a.jsx(t.Tab,{tab:"tab2",children:"Tab content for Tab 2"})]}),args:{defaultSelected:"tab1",variant:"underline",options:[{label:"Tab 1",tab:"tab1"},{label:"Tab 2",tab:"tab2"},{label:"Tab w/o Content",tab:"empty"}],className:"mb-3",vertical:!1}},o={decorators:[e=>a.jsx("div",{style:{width:"576px",height:"220px"},className:"d-flex justify-content-center gap-3",children:a.jsx(e,{})})],render:e=>a.jsxs(t,{...e,children:[a.jsx(t.Tab,{tab:"tab1",children:"Tab content for Tab 1. Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eligendi error beatae temporibus cupiditate quasi ut enim vero, consectetur mollitia soluta! Officiis maxime laboriosam, beatae quia earum id velit, doloribus, voluptatibus soluta ea molestiae? Quo molestiae rem iusto atque beatae aliquam."}),a.jsx(t.Tab,{tab:"tab2",children:"Tab content for Tab 2"})]}),args:{defaultSelected:"tab2",className:"me-3",options:[{label:"Tab 1",tab:"tab1"},{label:"Tab 2",tab:"tab2"},{label:"Tab w/o Content",tab:"empty"}],vertical:!0}},r={decorators:[e=>a.jsx("div",{style:{width:"576px",height:"220px"},className:"d-flex justify-content-center gap-3",children:a.jsx(e,{})})],render:e=>a.jsxs(t,{...e,children:[a.jsx(t.Tab,{tab:"tab1",children:"Tab content for Tab 1. Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eligendi error beatae temporibus cupiditate quasi ut enim vero, consectetur mollitia soluta! Officiis maxime laboriosam, beatae quia earum id velit, doloribus, voluptatibus soluta ea molestiae? Quo molestiae rem iusto atque beatae aliquam."}),a.jsx(t.Tab,{tab:"tab2",children:"Tab content for Tab 2"})]}),args:{defaultSelected:"tab2",options:[{label:"Tab 1",tab:"tab1"},{label:"Tab 2",tab:"tab2"},{label:"Tab w/o Content",tab:"empty"}],vertical:!1,variant:"pills",className:"mb-3"}},l={decorators:[e=>a.jsx("div",{style:{width:"576px",height:"220px"},className:"d-flex justify-content-center gap-3",children:a.jsx(e,{})})],render:e=>a.jsxs(t,{...e,children:[a.jsx(t.Tab,{tab:"tab1",children:"Tab content for Tab 1. Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eligendi error beatae temporibus cupiditate quasi ut enim vero, consectetur mollitia soluta! Officiis maxime laboriosam, beatae quia earum id velit, doloribus, voluptatibus soluta ea molestiae? Quo molestiae rem iusto atque beatae aliquam."}),a.jsx(t.Tab,{tab:"tab2",children:"Tab content for Tab 2"})]}),args:{defaultSelected:"tab2",options:[{label:"Tab 1",tab:"tab1"},{label:"Tab 2",tab:"tab2"},{label:"Tab w/o Content",tab:"empty"}],vertical:!0,variant:"pills",className:"me-3"}},b={decorators:[e=>a.jsx("div",{style:{width:"576px",height:"220px"},className:"d-flex justify-content-center gap-3",children:a.jsx(e,{})})],render:e=>a.jsxs(t,{...e,children:[a.jsx(t.Tab,{tab:"tab1",children:"Tab content for Tab 1. Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eligendi error beatae temporibus cupiditate quasi ut enim vero, consectetur mollitia soluta! Officiis maxime laboriosam, beatae quia earum id velit, doloribus, voluptatibus soluta ea molestiae? Quo molestiae rem iusto atque beatae aliquam."}),a.jsx(t.Tab,{tab:"tab2",children:"Tab content for Tab 2"})]}),args:{defaultSelected:"tab2",options:[{label:"Tab 1",tab:"tab1"},{label:"Tab 2",tab:"tab2"},{label:"Tab w/o Content",tab:"empty"}],vertical:!1,variant:"tabs",className:"mb-3"}};var n,c,u;s.parameters={...s.parameters,docs:{...(n=s.parameters)==null?void 0:n.docs,source:{originalSource:`{
...
}`,...(j=(q=b.parameters)==null?void 0:q.docs)==null?void 0:j.source}}};const Q=["Default","Vertical","Pills","VerticalPills","Tabs"];export{s as Default,r as Pills,b as Tabs,o as Vertical,l as VerticalPills,Q as __namedExportsOrder,L as default};
