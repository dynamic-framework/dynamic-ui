...
| --${e}chip-line-height   | .d-chip | css length unit | Line height                      |
        `}}},argTypes:{style:{control:"object"},className:{control:"text",type:"string"},text:{control:"text",type:"string",description:"Text of badge"},theme:{control:"select",type:"string",options:K,table:{defaultValue:{summary:"primary"}},description:"The theme to use."},icon:{control:{type:"select",labels:{undefined:"empty"}},options:[void 0,...f]},iconFamilyClass:{control:"text",type:"string"},iconFamilyPrefix:{control:"text",type:"string"},iconMaterialStyle:{control:"boolean",type:"boolean"},iconClose:{control:{type:"select",labels:{undefined:"empty"}},options:[void 0,...f]},iconCloseFamilyClass:{control:"text",type:"string"},iconCloseFamilyPrefix:{control:"text",type:"string"},iconCloseMaterialStyle:{control:"boolean",type:"boolean"},showClose:{control:"boolean",table:{defaultValue:{summary:"false"}},type:"boolean"},closeAriaLabel:{control:"text",type:"string"},onClose:{action:"onClose"}},tags:["autodocs"]},a={args:{theme:"primary",text:"Default"}},r={args:{theme:"secondary",text:"Default"}},s={args:{theme:"secondary",text:"Default",icon:"fire"}},o={args:{theme:"secondary",text:"Default",icon:"fire",showClose:!0}},i={render:n=>t.jsx(J,{...Q,children:t.jsx(l,{...n})}),args:{theme:"secondary",text:"Default",icon:"local_fire_department",showClose:!0},parameters:{docs:{canvas:{sourceState:"shown"}}}};var y,h,g;a.parameters={...a.parameters,docs:{...(y=a.parameters)==null?void 0:y.docs,source:{originalSource:`{
  args: {
    theme: 'primary',
    text: 'Default'
  }
}`,...(g=(h=a.parameters)==null?void 0:h.docs)==null?void 0:g.source}}};var C,x,b;r.parameters={...r.parameters,docs:{...(C=r.parameters)==null?void 0:C.docs,source:{originalSource:`{
  args: {
    theme: 'secondary',
    text: 'Default'
  }
}`,...(b=(x=r.parameters)==null?void 0:x.docs)==null?void 0:b.source}}};var D,S,V;s.parameters={...s.parameters,docs:{...(D=s.parameters)==null?void 0:D.docs,source:{originalSource:`{
  args: {
    theme: 'secondary',
    text: 'Default',
    icon: 'fire'
  }
}`,...(V=(S=s.parameters)==null?void 0:S.docs)==null?void 0:V.source}}};var P,_,F;o.parameters={...o.parameters,docs:{...(P=o.parameters)==null?void 0:P.docs,source:{originalSource:`{
  args: {
    theme: 'secondary',
    text: 'Default',
    icon: 'fire',
...
}`,...(w=(I=i.parameters)==null?void 0:I.docs)==null?void 0:w.source}}};const ie=["Primary","Secondary","Icon","Close","MaterialIcon"];export{o as Close,s as Icon,i as MaterialIcon,a as Primary,r as Secondary,ie as __namedExportsOrder,oe as default};
