...
function DVoucher({ amount, amountDetails, icon = 'CircleCheckBig', color = 'success', title, onError, message, downloadText = 'Download', shareText = 'Share', children, }) {
    ...
    return (jsx("div", { className: "d-voucher", ref: (el) => {
        ...
        }, children: jsxs("div", { children: [jsxs("div", { className: "d-voucher-header", children: [jsx(DIcon, { icon: icon, size: "var(--bs-ref-spacer-8)", color: color }), jsxs("div", { className: "text-center", children: [jsx("h3", { className: "mb-2", children: title }), jsx("p", { className: "m-0", children: message })] })] }), amount && (jsxs("div", { className: "d-voucher-amount", children: [jsx("div", { className: classNames('text-center fw-bold fs-3', amountDetails ? 'mb-1' : 'm-0'), children: amount }), amountDetails] })), jsx("hr", { className: "my-4" }), children, jsx("hr", { className: "my-4" }), jsxs("div", { className: "d-voucher-footer", children: [jsx(DButton, { onClick: () => share().catch((err) => onError === null || onError === void 0 ? void 0 : onError(err)), iconStart: "Share2", text: shareText, variant: "outline", size: "sm" }), jsx(DButton, { onClick: () => download().catch((err) => onError === null || onError === void 0 ? void 0 : onError(err)), iconStart: "Download", text: downloadText, variant: "outline", size: "sm" })] })] }) }));
}
