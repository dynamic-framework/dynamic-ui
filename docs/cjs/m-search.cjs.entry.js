...
const MSearch = class {
  ...
  render() {
    return (index.h(index.Host, { class: this.generateHostClasses() }, this.label && (index.h("label", { htmlFor: this.mId }, this.label, this.labelIcon && (index.h("m-icon", { class: "form-control-icon label-icon", icon: this.labelIcon, familyClass: this.labelIconFamilyClass, familyPrefix: this.labelIconFamilyPrefix })))), index.h("div", { class: "form-control-input" }, index.h("div", { class: "input-group" }, index.h("input", {
    ...
    }), (this.iconEnd && !!this.theme && !this.isLoading) && (index.h("span", { class: "input-group-text", id: `${this.mId}-end` }, this.iconEnd && (index.h("m-icon", { class: "form-control-icon search-state", icon: this.iconEnd, familyClass: this.iconEndFamilyClass, familyPrefix: this.iconEndFamilyPrefix })))), this.isLoading && (index.h("div", { class: "input-group-text form-control-icon" }, index.h("span", { class: "spinner-border spinner-border-sm", role: "status", "aria-hidden": "true" }, index.h("span", { class: "visually-hidden" }, "Loading...")))), !this.isLoading && (index.h("button", { class: "btn btn-text btn-search", disabled: this.isDisabled, onClick: this.clickHandler }, index.h("m-icon", { icon: "search" })))), this.hint && (index.h("small", { class: "hint" }, this.hintIconStart && (index.h("m-icon", { class: "form-control-icon hint-icon", icon: this.hintIconStart, familyClass: this.hintIconStartFamilyClass, familyPrefix: this.hintIconStartFamilyPrefix })), this.hint, this.hintIconEnd && (index.h("m-icon", { class: "form-control-icon hint-icon", icon: this.hintIconEnd, familyClass: this.hintIconEndFamilyClass, familyPrefix: this.hintIconEndFamilyPrefix })))))));
  }
};
MSearch.style = mSearchCss;

exports.m_search = MSearch;
