...
const MModal = class {
  ...
  render() {
    return (index.h("div", Object.assign({ class: "modal fade show d-block", id: this.name, tabindex: "-1", "aria-labelledby": `${this.name}Label`, "aria-hidden": "false" }, this.isStatic && ({
      [`data-${componentInterface.prefixBS}backdrop`]: 'static',
      [`data-${componentInterface.prefixBS}keyboard`]: 'false',
    })), index.h("div", Object.assign({ class: this.generateModalDialogClasses() }, this.imageHeader && ({ style: { [`--${componentInterface.prefixBS}header-bg-image`]: `url("${this.imageHeader}")` } })), index.h("div", { class: "modal-content" }, this.header && (index.h("div", { class: {
        'modal-header': true,
        'modal-header-bg-image': !!this.imageHeader,
      } }, index.h("slot", { name: "header" }), this.showCloseButton && (index.h("button", { type: "button", class: {
        'btn-close': !this.closeText,
        'btn-close-text': !!this.closeText,
      }, "aria-label": "Close", onClick: this.closeHandler }, this.closeText && (this.closeText))))), this.body && (index.h("div", { class: "modal-body" }, index.h("slot", { name: "body" }))), this.footer && (index.h("div", { class: "modal-footer" }, index.h("slot", { name: "footer" })))))));
  }
