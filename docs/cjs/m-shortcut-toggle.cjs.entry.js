...
const MShortcutToggle = class {
  ...
  render() {
    return (index.h("label", { class: {
      ...
      }, htmlFor: this.mId }, index.h("input", { id: this.mId, type: "radio", name: this.name, value: this.value, checked: this.isChecked, onChange: this.changeHandler, disabled: this.state === 'disabled' }), ((this.text || this.label) && !this.icon) && (index.h("div", { class: this.white ? 'shortcut-toggle-white' : 'shortcut-toggle' }, this.label && (index.h("span", { class: "shortcut-label d-block" }, this.label)), this.text && (index.h("div", { class: "d-block small" }, index.h("span", { class: "shortcut-text" }, this.text, ' '), index.h("span", { class: "shortcut-subtext" }, this.subtext))))), this.icon && (index.h("div", { class: "shortcut-toggle" }, index.h("m-icon", { class: "shortcut-icon", icon: this.icon, familyClass: this.iconFamilyClass, familyPrefix: this.iconFamilyPrefix })))));
  }
};
MShortcutToggle.style = mShortcutToggleCss;

exports.m_shortcut_toggle = MShortcutToggle;
