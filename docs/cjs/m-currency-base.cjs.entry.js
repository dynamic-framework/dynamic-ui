...
const MCurrencyBase = class {
  constructor(hostRef) {
    ...
    this.onBlurEvent = (event) => {
      ...
      this.htmlInput.value = this.internalValue !== undefined
        ? currency_min.currency_min(this.internalValue, this.currencyOptions).format()
        : '';
    };
    this.onFocusEvent = () => {
  ...
  componentDidLoad() {
    ...
    if (this.internalValue !== undefined && !Number.isNaN(this.internalValue)) {
      this.htmlInput.value = currency_min.currency_min(this.internalValue, this.currencyOptions).format();
    }
    else {
  ...
  render() {
    return (index.h(index.Host, { class: this.generateHostClasses() }, this.label && (index.h("label", { htmlFor: this.mId }, this.label, index.h("m-icon", { class: "form-control-icon", icon: this.labelIcon, familyClass: this.labelIconFamilyClass, familyPrefix: this.labelIconFamilyPrefix }))), index.h("div", { class: "form-control-input" }, index.h("div", { class: {
        'input-group': true,
        disabled: this.isDisabled || this.isLoading,
      } }, this.iconStart && (index.h("span", { class: "input-group-text", id: `${this.mId}-start` }, index.h("m-icon", { class: "form-control-icon", icon: this.iconStart, familyClass: this.iconStartFamilyClass, familyPrefix: this.iconStartFamilyPrefix }))), this.selectOptions.length > 0 && (index.h("select", {
      // eslint-disable-next-line no-return-assign
      ref: (el) => (this.htmlSelect = el), class: "form-select", disabled: this.isDisabled || this.isLoading, onInput: this.changeHandler
    }, this.selectOptions.map((opt) => (index.h("option", { value: this.valueExtractor(opt) }, this.labelExtractor(opt)))))), index.h("input", {
      // eslint-disable-next-line no-return-assign
      ref: (el) => (this.htmlInput = el), id: this.mId, type: "number", disabled: this.isDisabled || this.isLoading, min: this.minValue, max: this.maxValue, class: "form-control", value: this.value, placeholder: this.placeholder
        ? this.placeholder
        : currency_min.currency_min(0, this.currencyOptions).format(), "aria-label": this.label, "aria-describedby": `${this.mId}-add`, onInput: this.changeHandler, onBlur: this.onBlurEvent, onFocus: this.onFocusEvent, onWheel: this.onWheelEvent
    }), this.iconMiddle && (index.h("span", { class: "input-group-text", id: `${this.mId}-middle` }, index.h("m-icon", { class: "form-control-icon", icon: this.iconMiddle, familyClass: this.iconMiddleFamilyClass, familyPrefix: this.iconMiddleFamilyPrefix }))), (this.iconEnd && !this.isLoading) && (index.h("span", { class: "input-group-text", id: `${this.mId}-end` }, index.h("m-icon", { class: "form-control-icon", icon: this.iconEnd, familyClass: this.iconEndFamilyClass, familyPrefix: this.iconEndFamilyPrefix }))), this.isLoading && (index.h("div", { class: "form-control-icon" }, index.h("span", { class: "spinner-border spinner-border-sm", role: "status", "aria-hidden": "true" }, index.h("span", { class: "visually-hidden" }, "Loading..."))))), this.hint && (index.h("m-hint", Object.assign({ text: this.hint }, (this.hintIconStart && ({
...
exports.m_currency_base = MCurrencyBase;
