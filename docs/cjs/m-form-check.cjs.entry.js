...
const MFormCheck = class {
  ...
  render() {
    return (index.h(index.Host, { class: "form-check-box" }, this.label ? (index.h("div", { class: this.isButton ? '' : 'form-check' }, index.h("input", { onChange: (event) => this.changeHandler(event), class: this.generateClasses(), type: this.type, name: this.name, id: this.mId, value: this.value, checked: this.isChecked, disabled: this.isDisabled, indeterminate: this.isIndeterminate }), index.h("label", { class: this.isButton ? 'form-check-box-label' : 'form-check-label', htmlFor: this.mId }, this.label))) : (index.h("input", { onChange: (event) => this.changeHandler(event), class: this.generateClasses(), type: this.type, name: this.name, id: this.mId, value: this.value, checked: this.isChecked, disabled: this.isDisabled, indeterminate: this.isIndeterminate }))));
  }
};
MFormCheck.style = mFormCheckCss;

exports.m_form_check = MFormCheck;
