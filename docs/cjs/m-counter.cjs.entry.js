...
const MCounter = class {
  constructor(hostRef) {
    ...
    this.mInput = index.createEvent(this, "mInput", 7);
    this.mClick = index.createEvent(this, "mClick", 7);
    this.validStates = Object.keys(componentInterface.ICON_STATE).filter((k) => !['light', 'info'].includes(k));
  ...
  render() {
    return (index.h(index.Host, { class: this.generateHostClasses() }, this.label && (index.h("label", { htmlFor: this.mId }, this.label, this.labelIcon && (index.h("m-icon", { class: "form-control-icon", icon: this.labelIcon, familyClass: this.labelIconFamilyClass, familyPrefix: this.labelIconFamilyPrefix })))), index.h("div", { class: "form-control-input" }, index.h("div", { class: "input-group" }, index.h("div", { class: "form-control" }, index.h("div", { class: "form-control-spacer" }), index.h("div", { class: "form-control-counter" }, index.h("button", { class: "form-control-counter-btn", onClick: () => this.clickHandler(false), disabled: this.isDisabled }, index.h("m-icon", { icon: "dash" })), index.h("input", { class: "form-control-counter-input", type: "number", id: this.mId, min: this.minValue, max: this.maxValue, value: this.internalValue, onInput: this.inputHandler, disabled: this.isDisabled }), index.h("button", { class: "form-control-counter-btn", onClick: () => this.clickHandler(true), disabled: this.isDisabled }, index.h("m-icon", { icon: "plus" }))), (!this.state && !this.isLoading) && (index.h("div", { class: "form-control-spacer" })), (this.state && !this.isLoading) && (index.h("m-icon", { class: "form-control-icon icon-state", icon: componentInterface.ICON_STATE[this.state] })), this.isLoading && (index.h("div", { class: "form-control-icon" }, index.h("span", { class: "spinner-border spinner-border-sm", role: "status", "aria-hidden": "true" }, index.h("span", { class: "visually-hidden" }, "Loading...")))))), this.hint && (index.h("m-hint", Object.assign({ text: this.hint, theme: this.state ? this.getTheme(this.state) : undefined }, (this.hintIconStart && ({
