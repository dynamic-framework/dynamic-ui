...
const MQuickAction = class {
  ...
  render() {
    return (index.h(index.Host, { class: this.generateHostClasses() }, index.h("button", { class: this.generateButtonClasses(), onClick: this.clickHandler, disabled: this.state === 'disabled' }, index.h("div", { class: "quick-action-picture" }, (this.icon && !this.image) && (index.h("m-icon", { class: "quick-action-icon", icon: this.icon })), this.image && (index.h("img", { class: "quick-action-img", src: this.image, alt: "Quick action" }))), index.h("div", { class: "quick-action-content" }, index.h("div", { class: "quick-action-text" }, index.h("span", { class: "quick-action-title" }, this.text), this.subtext && (index.h("small", { class: "quick-action-subtitle" }, this.subtext, this.extraInfo && (` - ${this.extraInfo}`)))), (this.actionIcon && !this.actionWord) && (index.h("m-icon", { size: "1.125rem", class: "quick-action-link", icon: this.actionIcon, familyClass: this.iconFamilyClass, familyPrefix: this.iconFamilyPrefix })), this.actionWord && (index.h("small", { class: "quick-action-link" }, this.actionWord))))));
  }
};
MQuickAction.style = mQuickActionCss;

exports.m_quick_action = MQuickAction;
