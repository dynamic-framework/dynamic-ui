...
const MPin = class {
  ...
  render() {
    return (index.h(index.Host, { class: this.generateHostClasses() }, this.label && (index.h("label", { htmlFor: "pin-index-0" }, this.label, this.labelIcon && (index.h("m-icon", { class: "form-control-icon", icon: this.labelIcon, familyClass: this.labelIconFamilyClass, familyPrefix: this.labelIconFamilyPrefix })))), index.h("form", { id: this.mId, class: "form-control-input", onInput: this.formChange, onSubmit: this.preventDefaultEvents }, this.iconStart && (index.h("span", { class: "input-group-text", id: `${this.mId}-start` }, this.iconStart && (index.h("m-icon", { class: "form-control-icon", icon: this.iconStart, familyClass: this.iconStartFamilyClass, familyPrefix: this.iconStartFamilyPrefix })))), Array.from({ length: this.characters }).map((_, index$1) => (index.h("input", Object.assign({ class: "pin-item", type: this.isSecret ? 'password' : this.type, inputMode: this.mInputMode, id: `pin-index-${index$1}`, name: `pin-${index$1}`, maxLength: 1, onInput: this.nextInput, onKeyDown: this.prevInput, onFocus: this.focusInput, onWheel: this.wheelInput, onClick: this.preventDefaultEvents, autocomplete: "off", placeholder: this.placeholder, disabled: this.isDisabled || this.isLoading, required: true }, this.type === 'number' && ({
      min: 0,
      max: 9,
    }))))), (this.iconEnd && !this.isLoading) && (index.h("span", { class: "input-group-text", id: `${this.mId}-end` }, index.h("m-icon", { class: "form-control-icon icon-end", icon: this.iconEnd, familyClass: this.iconEndFamilyClass, familyPrefix: this.iconEndFamilyPrefix }))), this.isLoading && (index.h("div", { class: "input-group-text form-control-icon" }, index.h("span", { class: "spinner-border spinner-border-sm", role: "status", "aria-hidden": "true" }, index.h("span", { class: "visually-hidden" }, "Loading..."))))), this.hint && (index.h("m-hint", Object.assign({ text: this.hint, theme: this.theme === 'danger' || this.theme === 'tertiary' || this.theme === 'warning' ? this.theme : undefined }, (this.hintIconStart && ({
