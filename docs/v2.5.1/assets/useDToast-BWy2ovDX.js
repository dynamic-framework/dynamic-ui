import{j as t}from"./jsx-runtime-D_zvdyIk.js";import{useMDXComponents as K}from"./index-tur7TIeT.js";import{M as ie,U as w,c as v}from"./blocks-D3KWqHh1.js";import{r as d}from"./iframe-DzLAgS8h.js";import{D as k}from"./DButton-lpbH0naU.js";import{c as Y}from"./index-D8Sp-yS4.js";import{D as E}from"./DToast-C53_R8xQ.js";import{D as S}from"./DIcon-D_YzQNEj.js";import{u as ae,D as L}from"./DContext-CT--TS2e.js";import{D as ce}from"./DAlert-BG0Z5sS4.js";import"./preload-helper-Dp1pzeXC.js";import"./index-wnSgjbxo.js";import"./index-CGSmvm0H.js";import"./config-C3iYXcFk.js";import"./useMediaBreakpointUp-BSP7KcW1.js";let le={data:""},de=s=>{if(typeof window=="object"){let e=(s?s.querySelector("#_goober"):window._goober)||Object.assign(document.createElement("style"),{innerHTML:" ",id:"_goober"});return e.nonce=window.__nonce__,e.parentNode||(s||document.head).appendChild(e),e.firstChild}return s||le},he=/(?:([\u0080-\uFFFF\w-%@]+) *:? *([^{;]+?);|([^;}{]*?) *{)|(}\s*)/g,pe=/\/\*[^]*?\*\/|  +/g,G=/\n+/g,D=(s,e)=>{let o="",n="",a="";for(let i in s){let r=s[i];i[0]=="@"?i[1]=="i"?o=i+" "+r+";":n+=i[1]=="f"?D(r,i):i+"{"+D(r,i[1]=="k"?"":e)+"}":typeof r=="object"?n+=D(r,e?e.replace(/([^,])+/g,c=>i.replace(/([^,]*:\S+\([^)]*\))|([^,])+/g,l=>/&/.test(l)?l.replace(/&/g,c):c?c+" "+l:l)):i):r!=null&&(i=/^--/.test(i)?i:i.replace(/[A-Z]/g,"-$&").toLowerCase(),a+=D.p?D.p(i,r):i+":"+r+";")}return o+(e&&a?e+"{"+a+"}":a)+n},y={},Q=s=>{if(typeof s=="object"){let e="";for(let o in s)e+=o+Q(s[o]);return e}return s},ue=(s,e,o,n,a)=>{let i=Q(s),r=y[i]||(y[i]=(l=>{let h=0,u=11;for(;h<l.length;)u=101*u+l.charCodeAt(h++)>>>0;return"go"+u})(i));if(!y[r]){let l=i!==s?s:(h=>{let u,p,m=[{}];for(;u=he.exec(h.replace(pe,""));)u[4]?m.shift():u[3]?(p=u[3].replace(G," ").trim(),m.unshift(m[0][p]=m[0][p]||{})):m[0][u[1]]=u[2].replace(G," ").trim();return m[0]})(s);y[r]=D(a?{["@keyframes "+r]:l}:l,o?"":"."+r)}let c=o&&y.g?y.g:null;return o&&(y.g=y[r]),((l,h,u,p)=>{p?h.data=h.data.replace(p,l):h.data.indexOf(l)===-1&&(h.data=u?l+h.data:h.data+l)})(y[r],e,n,c),r},xe=(s,e,o)=>s.reduce((n,a,i)=>{let r=e[i];if(r&&r.call){let c=r(o),l=c&&c.props&&c.props.className||/^go/.test(c)&&c;r=l?"."+l:c&&typeof c=="object"?c.props?"":D(c,""):c===!1?"":c}return n+a+(r??"")},"");function F(s){let e=this||{},o=s.call?s(e.p):s;return ue(o.unshift?o.raw?xe(o,[].slice.call(arguments,1),e.p):o.reduce((n,a)=>Object.assign(n,a&&a.call?a(e.p):a),{}):o,de(e.target),e.g,e.o,e.k)}let J,z,U;F.bind({g:1});let b=F.bind({k:1});function me(s,e,o,n){D.p=e,J=s,z=o,U=n}function T(s,e){let o=this||{};return function(){let n=arguments;function a(i,r){let c=Object.assign({},i),l=c.className||a.className;o.p=Object.assign({theme:z&&z()},c),o.o=/ *go\d+/.test(l),c.className=F.apply(o,n)+(l?" "+l:"");let h=s;return s[0]&&(h=c.as||s,delete c.as),U&&h[0]&&U(c),J(h,c)}return e?e(a):a}}var fe=s=>typeof s=="function",$=(s,e)=>fe(s)?s(e):s,je=(()=>{let s=0;return()=>(++s).toString()})(),ee=(()=>{let s;return()=>{if(s===void 0&&typeof window<"u"){let e=matchMedia("(prefers-reduced-motion: reduce)");s=!e||e.matches}return s}})(),ge=20,V="default",te=(s,e)=>{let{toastLimit:o}=s.settings;switch(e.type){case 0:return{...s,toasts:[e.toast,...s.toasts].slice(0,o)};case 1:return{...s,toasts:s.toasts.map(r=>r.id===e.toast.id?{...r,...e.toast}:r)};case 2:let{toast:n}=e;return te(s,{type:s.toasts.find(r=>r.id===n.id)?1:0,toast:n});case 3:let{toastId:a}=e;return{...s,toasts:s.toasts.map(r=>r.id===a||a===void 0?{...r,dismissed:!0,visible:!1}:r)};case 4:return e.toastId===void 0?{...s,toasts:[]}:{...s,toasts:s.toasts.filter(r=>r.id!==e.toastId)};case 5:return{...s,pausedAt:e.time};case 6:let i=e.time-(s.pausedAt||0);return{...s,pausedAt:void 0,toasts:s.toasts.map(r=>({...r,pauseDuration:r.pauseDuration+i}))}}},I=[],se={toasts:[],pausedAt:void 0,settings:{toastLimit:ge}},g={},oe=(s,e=V)=>{g[e]=te(g[e]||se,s),I.forEach(([o,n])=>{o===e&&n(g[e])})},re=s=>Object.keys(g).forEach(e=>oe(s,e)),ye=s=>Object.keys(g).find(e=>g[e].toasts.some(o=>o.id===s)),B=(s=V)=>e=>{oe(e,s)},be={blank:4e3,error:4e3,success:2e3,loading:1/0,custom:4e3},ve=(s={},e=V)=>{let[o,n]=d.useState(g[e]||se),a=d.useRef(g[e]);d.useEffect(()=>(a.current!==g[e]&&n(g[e]),I.push([e,n]),()=>{let r=I.findIndex(([c])=>c===e);r>-1&&I.splice(r,1)}),[e]);let i=o.toasts.map(r=>{var c,l,h;return{...s,...s[r.type],...r,removeDelay:r.removeDelay||((c=s[r.type])==null?void 0:c.removeDelay)||(s==null?void 0:s.removeDelay),duration:r.duration||((l=s[r.type])==null?void 0:l.duration)||(s==null?void 0:s.duration)||be[r.type],style:{...s.style,...(h=s[r.type])==null?void 0:h.style,...r.style}}});return{...o,toasts:i}},De=(s,e="blank",o)=>({createdAt:Date.now(),visible:!0,dismissed:!1,type:e,ariaProps:{role:"status","aria-live":"polite"},message:s,pauseDuration:0,...o,id:(o==null?void 0:o.id)||je()}),P=s=>(e,o)=>{let n=De(e,s,o);return B(n.toasterId||ye(n.id))({type:2,toast:n}),n.id},x=(s,e)=>P("blank")(s,e);x.error=P("error");x.success=P("success");x.loading=P("loading");x.custom=P("custom");x.dismiss=(s,e)=>{let o={type:3,toastId:s};e?B(e)(o):re(o)};x.dismissAll=s=>x.dismiss(void 0,s);x.remove=(s,e)=>{let o={type:4,toastId:s};e?B(e)(o):re(o)};x.removeAll=s=>x.remove(void 0,s);x.promise=(s,e,o)=>{let n=x.loading(e.loading,{...o,...o==null?void 0:o.loading});return typeof s=="function"&&(s=s()),s.then(a=>{let i=e.success?$(e.success,a):void 0;return i?x.success(i,{id:n,...o,...o==null?void 0:o.success}):x.dismiss(n),a}).catch(a=>{let i=e.error?$(e.error,a):void 0;i?x.error(i,{id:n,...o,...o==null?void 0:o.error}):x.dismiss(n)}),s};var Te=1e3,Ce=(s,e="default")=>{let{toasts:o,pausedAt:n}=ve(s,e),a=d.useRef(new Map).current,i=d.useCallback((p,m=Te)=>{if(a.has(p))return;let f=setTimeout(()=>{a.delete(p),r({type:4,toastId:p})},m);a.set(p,f)},[]);d.useEffect(()=>{if(n)return;let p=Date.now(),m=o.map(f=>{if(f.duration===1/0)return;let N=(f.duration||0)+f.pauseDuration-(p-f.createdAt);if(N<0){f.visible&&x.dismiss(f.id);return}return setTimeout(()=>x.dismiss(f.id,e),N)});return()=>{m.forEach(f=>f&&clearTimeout(f))}},[o,n,e]);let r=d.useCallback(B(e),[e]),c=d.useCallback(()=>{r({type:5,time:Date.now()})},[r]),l=d.useCallback((p,m)=>{r({type:1,toast:{id:p,height:m}})},[r]),h=d.useCallback(()=>{n&&r({type:6,time:Date.now()})},[n,r]),u=d.useCallback((p,m)=>{let{reverseOrder:f=!1,gutter:N=8,defaultPosition:W}=m||{},M=o.filter(j=>(j.position||W)===(p.position||W)&&j.height),ne=M.findIndex(j=>j.id===p.id),X=M.filter((j,q)=>q<ne&&j.visible).length;return M.filter(j=>j.visible).slice(...f?[X+1]:[0,X]).reduce((j,q)=>j+(q.height||0)+N,0)},[o]);return d.useEffect(()=>{o.forEach(p=>{if(p.dismissed)i(p.id,p.removeDelay);else{let m=a.get(p.id);m&&(clearTimeout(m),a.delete(p.id))}})},[o,i]),{toasts:o,handlers:{updateHeight:l,startPause:c,endPause:h,calculateOffset:u}}},we=b`
from {
...
to {
  ...
  animation: ${Re} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,Be=({toast:s})=>{let{icon:e,type:o,iconTheme:n}=s;return e!==void 0?typeof e=="string"?d.createElement(Fe,null,e):e:o==="blank"?null:d.createElement(Ae,null,d.createElement(Ne,{...n}),o!=="loading"&&d.createElement($e,null,o==="error"?d.createElement(_e,{...n}):d.createElement(Ie,{...n})))},Me=s=>`
...
`,t.jsx(v,{code:"const { toast } = useDToast();",language:"tsx",dark:!0}),`
...
`,language:"tsx",dark:!0})]})}function gt(s={}){const{wrapper:e}={...K(),...s.components};return e?t.jsx(e,{...s,children:t.jsx(Z,{...s})}):Z(s)}export{gt as default};
